    ...
    <div className="space-y-6">
        ...
        <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              maxLength={10000}
            />
            <p className="mt-1 text-xs text-gray-500">{formData.content.length}/10,000 characters</p>
          </div>
      ...
      {chunks.length === 0 && !isAdding && (
        <div className="text-center py-8 text-gray-500">
          ...
          <p className="text-xs text-gray-400">This step is optional. You can add knowledge later.</p>
        </div>
      )}
    </div>
  );
