 ...
 */
export const DashboardIcon: FC<IconProps> = ({ className = 'w-5 h-5', ...props }) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="none"
 ...
 */
export const NavDocumentIcon: FC<IconProps> = ({ className = 'w-5 h-5', ...props }) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="none"
 ...
 */
export const BotIcon: FC<IconProps> = ({ className = 'w-5 h-5', ...props }) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="none"
 ...
 */
export const ProfileIcon: FC<IconProps> = ({ className = 'w-5 h-5', ...props }) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="none"
 ...
 */
export const NavSettingsIcon: FC<IconProps> = ({ className = 'w-5 h-5', ...props }) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="none"
 ...
 */
export const SignOutIcon: FC<IconProps> = ({ className = 'w-5 h-5', ...props }) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="none"
