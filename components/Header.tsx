    ...
    <header className="sticky top-0 z-50 w-full border-b border-gray-200 bg-white/80 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-screen-xl items-center justify-between px-6">
        <Link href={{ pathname: '/' }} className="flex items-center flex-col">
          ...
          <span className="text-xs text-gray-400">Updated: {new Date().toUTCString()}</span>
        </Link>
        ...
        <nav className="hidden lg:flex items-center space-x-8">
          <div className="relative group">
            <Link href={{ pathname: '/bots' }} className="text-sm font-medium text-gray-600 hover:text-openai-green transition-colors">
              Bots
            </Link>
            <div className="absolute left-0 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 w-48 py-2 mt-1 bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 z-50">
              <Link href={{ pathname: '/bots/artistic-advisor' }} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                Artistic Advisor
              </Link>
              <Link href={{ pathname: '/bots/auto-shopper' }} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                Auto Shopper
              </Link>
              <Link href={{ pathname: '/bots/gov-spending-tracker' }} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                Gov Spending Tracker
              </Link>
              <Link href={{ pathname: '/bots/legal-expert' }} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                Legal Expert
              </Link>
              <Link href={{ pathname: '/bots/medical-expert' }} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                Medical Expert
              </Link>
              <Link href={{ pathname: '/bots/swiss-german-teacher' }} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
          ...
          <Link href={{ pathname: '/about' }} className="text-sm font-medium text-gray-600 hover:text-openai-green transition-colors">
            About
          </Link>
          <Link 
