  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-gray-200 bg-white/80 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-screen-xl items-center justify-between px-6">
        <Link href="/" className="flex items-center space-x-2 mr-4 lg:mr-0">
        ...
        <button
          type="button"
          onClick={toggleMenu}
          className="lg:hidden rounded-md p-3 text-gray-600 hover:bg-gray-100 hover:text-openai-green focus:outline-none focus:ring-2 focus:ring-openai-green"
              ...
              <div className="space-y-3">
                ...
                <div className="flex flex-col space-y-4 pl-4">
                  <Link 
                    ...
                    className="flex items-center min-h-[44px] text-base text-gray-600 hover:text-openai-green active:text-openai-green transition-colors">
                    Artistic Advisor
                  </Link>
                  <Link 
                  ...
                  <Link 
                    href="/bots/gov-spending-tracker" 
                    className="flex items-center min-h-[44px] text-base text-gray-600 hover:text-openai-green active:text-openai-green transition-colors">
                    Gov Spending Tracker
                  </Link>
                  <Link 
