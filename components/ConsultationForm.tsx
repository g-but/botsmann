      ...
      <div className="mx-auto max-w-xl bg-white p-8 rounded-lg shadow-sm border border-green-100">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-600 mb-6">
            We're excited about your interest in collaborating. We'll be in
            touch soon to discuss how we can work together on groundbreaking AI
            solutions.
          </p>
          <button
    ...
    <div className="mx-auto max-w-xl bg-white p-6 md:p-8 rounded-lg shadow-sm">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div>
          ...
          <select
            {...register("expertise", {
              required: "Please select an area of expertise",
            })}
            id="expertise"
