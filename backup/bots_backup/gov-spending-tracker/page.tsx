      ...
      <div className="space-y-4">
            ...
            <div className="flex-grow">
              <div className="flex items-center justify-between">
                <p className="text-sm text-gray-500">
                  Payment ID: #GOV-2024-001
                </p>
                <p className="text-sm text-gray-500">Feb 8, 2024</p>
              </div>
              <div className="mt-2">
                <p className="font-medium">
                  <span className="text-openai-green">
              ...
              <div className="mt-3">
                <p className="text-gray-600">
                  Road maintenance and repair - Highway 101 Section B
                </p>
                <p className="mt-1 text-sm text-gray-500">
                  Legal basis: Contract #DOT-2024-789
                </p>
              </div>
        ...
        <div className="rounded-md bg-gray-50 p-4">
          <p className="text-sm text-gray-600">
            🔒 Some recipient names may be altered to protect individual
            privacy, particularly for welfare recipients. This ensures
            transparency while maintaining personal data protection.
          </p>
        </div>
      </div>
    </div>
