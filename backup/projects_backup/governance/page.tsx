  ...
  return (
    <div className="min-h-screen bg-white">
      <main className="mx-auto max-w-screen-xl px-6 py-16">
        <div className="mb-16">
          <h1 className="mb-4 text-4xl font-semibold tracking-tight text-gray-900">Government Spending Tracker</h1>
        ...
        <div className="grid gap-8 md:grid-cols-2">
          <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
            <h2 className="mb-4 text-2xl font-semibold text-gray-900">Transaction Details</h2>
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
            <h2 className="mb-4 text-2xl font-semibold text-gray-900">Social Features</h2>
            <p className="mb-6 text-gray-600">
        ...
        <div className="mt-16">
          <h2 className="mb-8 text-3xl font-semibold text-gray-900">Demo Timeline</h2>
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-6">
              <div className="mb-4 flex items-center justify-between">
                <div>
                  ...
                  <h3 className="text-lg font-medium text-gray-900">Department of Education → Local School District</h3>
                </div>
              ...
              <p className="mb-4 text-gray-600">Annual funding for STEM education programs and equipment upgrades.</p>
              <div className="flex items-center justify-between">
                <div className="flex space-x-4">
                  <button className="flex items-center text-sm text-gray-500 hover:text-brand-500">
                ...
                <button className="rounded-md bg-brand-500 px-4 py-2 text-sm font-medium text-white hover:bg-opacity-90">
                  Donate
                </button>
              </div>
            </div>
        ...
        <div className="mt-16">
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
            <p className="mb-6 text-lg text-gray-600">
              Help us promote government transparency and accountability. Contact us to learn more
              about implementing the Government Spending Tracker in your jurisdiction.
            </p>
            <Link
              href="/about"
