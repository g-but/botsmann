...
const DailyQuestionsSection: React.FC = () => {
  ...
  const currentField =
    researchFields.find((field) => field.id === selectedField) ||
    researchFields[0];
  ...
  const handleAddCustomField = () => {
    // In a real implementation, this would add the field to the user's profile
    // For now, we'll direct them to ChatGPT
    window.open("https://chatgpt.com/g/research-assistant", "_blank");
  };
    ...
    <section className={styles.featureSection} id="daily-questions">
      <div className={styles.container}>
        ...
        <p className={styles.featureSubtitle}>
          Venture down intellectually stimulating paths that challenge your
          thinking and lead to unexpected discoveries
        </p>
        ...
        <div className={styles.questionFeatures}>
          <div className={styles.featureCard}>
            ...
            <p>
              Questions adapt to your research interests and evolve as your
              intellectual journey progresses
            </p>
          </div>
          <div className={styles.featureCard}>
            <h4>Interdisciplinary Connections</h4>
            <p>
              Discover unexpected links between your field and others to inspire
          ...
          <div className={styles.featureCard}>
            ...
            <p>
              Build a library of your responses to track the evolution of your
              thinking over time
            </p>
          </div>
          <div className={styles.featureCard}>
            ...
            <p>
              Share questions with colleagues and compare responses to generate
              new insights
            </p>
          </div>
        </div>
