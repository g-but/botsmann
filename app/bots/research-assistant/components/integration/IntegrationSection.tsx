...
const IntegrationSection: React.FC = () => {
  ...
  const currentTool =
    integrationTools.find((tool) => tool.id === selectedTool) ||
    integrationTools[0];
    ...
    <div className="my-24">
      <div className="mb-8 text-center">
        ...
        <p className="text-gray-700 max-w-3xl mx-auto">
          Connect with researchers, raise funding, access resources, and create
          collaborative workspaces free from institutional constraints and
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm">
          ...
          {activeFeature === "find-peers" && (
            <div className="bg-indigo-50 p-4 rounded-lg">
              ...
              <ul className="list-disc pl-5 space-y-1 text-gray-700">
                ...
                <li>
                  Anonymous collaboration options to focus on ideas, not
                  credentials
                </li>
                <li>Discover researchers working on complementary problems</li>
                <li>
                  Connect across disciplines, institutions, and geographical
                  boundaries
                </li>
                <li>
                  Build research networks based on shared interests, not
          ...
          {activeFeature === "raise-funding" && (
            <div className="bg-indigo-50 p-4 rounded-lg">
              ...
              <ul className="list-disc pl-5 space-y-1 text-gray-700">
                <li>
                  Access to quadratic funding pools for community-valued
                  research
                </li>
                <li>
                  Connect with research DAOs (Decentralized Autonomous
                  Organizations)
                </li>
                <li>
                ...
                <li>
                  Crowdfund specific research initiatives from interested
                  communities
                </li>
                <li>
          ...
          {activeFeature === "find-resources" && (
            <div className="bg-indigo-50 p-4 rounded-lg">
              ...
              <ul className="list-disc pl-5 space-y-1 text-gray-700">
                <li>
                  Access shared computational resources for intensive research
                  tasks
                </li>
                <li>
                ...
                <li>
                  Find specialized equipment through peer-to-peer sharing
                  networks
                </li>
                <li>
                  Access journal subscriptions and paywalled content through
                  community pools
                </li>
                <li>
          ...
          {activeFeature === "create-workspaces" && (
            <div className="bg-indigo-50 p-4 rounded-lg">
              ...
              <ul className="list-disc pl-5 space-y-1 text-gray-700">
                <li>
                  Create shared workspaces that integrate with your preferred
                  tools
                </li>
                <li>
                  Real-time collaboration with version control and change
                  tracking
                </li>
                <li>
                ...
                <li>
                  Integrated communication channels for synchronous and
                  asynchronous work
                </li>
              </ul>
            </div>
      ...
      <div className="mt-16 text-center">
        <p className="text-gray-700 mb-6 max-w-2xl mx-auto">
          Join our decentralized science community and transform how research is
          conducted, funded, and shared—free from traditional gatekeepers and
