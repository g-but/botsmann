...
const DevelopmentRoadmap: React.FC = () => {
  const [collaborationType, setCollaborationType] =
    useState<CollaborationType>("developer");

  const roadmapItems = [
    {
      title: "Concept Development",
      description:
        "Initial concept development and research on AI-powered research assistants",
      timeframe: "2025 Q1",
      icon: "🧪",
      completed: true,
    },
    {
      ...
      description:
        "First internal prototype focusing on research organization and tagging",
      timeframe: "2025 Q3",
      icon: "📁",
      completed: false,
    },
    {
      ...
      description:
        "Limited beta with researchers for research organization and updates features",
      timeframe: "2026 Q1",
      icon: "🔍",
      completed: false,
    },
    ...
    },
    {
      ...
      description:
        "Official public launch of the complete Nerd platform with all core features",
      timeframe: "2027 Q3",
      icon: "🚀",
      completed: false,
    },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <div className="max-w-3xl mx-auto">
            <p className="text-lg text-gray-700 mb-6">
              Nerd envisions a future where humans and machines collaborate
              fluidly in pursuit of truth and knowledge. We're building a
              platform that transcends traditional barriers of credentialism and
              institutional gatekeeping, while leveraging the power of AI to
              accelerate research and discovery toward technological
              singularity.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="bg-blue-50 p-5 rounded-lg vision-card">
                ...
                <p className="text-gray-600">
                  Developing intelligent systems that enhance human creativity
                  and analytical capabilities, creating a symbiotic relationship
                  that elevates research beyond current limitations.
                </p>
              </div>
              ...
              <div className="bg-purple-50 p-5 rounded-lg vision-card">
                ...
                <p className="text-gray-600">
                  Democratizing research through blockchain-based systems,
                  alternative funding mechanisms like DAOs, and removing
                  institutional barriers that prevent brilliant minds from
                  contributing.
                </p>
              </div>
              ...
              <div className="bg-green-50 p-5 rounded-lg vision-card">
                ...
                <p className="text-gray-600">
                  Creating systems that identify promising connections across
                  disciplines, surface overlooked research, and generate novel
                  hypotheses—dramatically speeding the path to breakthrough
                  discoveries.
                </p>
              </div>
            </div>
            ...
            <p className="text-gray-700">
              By our 2027 launch, Nerd will provide a comprehensive platform
              where anyone with intellectual curiosity can contribute to human
              knowledge advancement, regardless of formal credentials. We're
              building a future where AI amplifies human potential,
              decentralized structures remove traditional gatekeepers, and
              collaborative intelligence drives us toward an unprecedented
              ...
              {roadmapItems.map((item, index) => (
                ...
                >
                  <div
                    ...
                    style={{
                      backgroundColor: item.completed ? "#3B82F6" : "#DBEAFE",
                    }}
                  >
        ...
        <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-6 md:p-8">
          ...
          <p className="text-gray-700 mb-8 max-w-3xl mx-auto text-center">
            Join our collaborative community of engineers, researchers, and
            domain experts working together to redefine what's possible in
            research. Help shape the future of Nerd before our 2026 launch.
          </p>
          ...
          <div className="mb-10">
            ...
            {collaborationType === "developer" && (
              <div className="space-y-4 bg-white rounded-lg p-6 shadow-sm">
                ...
                <p className="text-gray-700">
                  Help build Nerd's AI-powered tools that will transform how
                  knowledge is discovered, organized, and shared.
                </p>
                <div className="text-left max-w-2xl mx-auto mt-4">
                  <ul className="list-disc pl-5 text-gray-600 space-y-2">
                    <li>
                      Develop advanced knowledge graph systems for research
                      organization
                    </li>
                    <li>
                    ...
                    <li>
                      Build AI content creation systems for research papers and
                      social media
                    </li>
                    <li>
                    ...
                    <li>
                      Implement secure systems for anonymous and independent
                      research
                    </li>
                  </ul>
                </div>
            ...
            {collaborationType === "researcher" && (
              <div className="space-y-4 bg-white rounded-lg p-6 shadow-sm">
                ...
                <p className="text-gray-700">
                  Partner with us to ensure Nerd addresses real research
                  challenges and fits seamlessly into academic workflows.
                </p>
                <div className="text-left max-w-2xl mx-auto mt-4">
                  <ul className="list-disc pl-5 text-gray-600 space-y-2">
                    <li>
                      Test our research organization systems with your own
                      materials
                    </li>
                    <li>
                    ...
                    <li>
                      Advise on collaboration tools and independent research
                      features
                    </li>
                  </ul>
                </div>
            ...
            {collaborationType === "domain-expert" && (
              <div className="space-y-4 bg-white rounded-lg p-6 shadow-sm">
                ...
                <p className="text-gray-700">
                  Bring your unique expertise to help us develop Nerd's
                  capabilities across different fields and disciplines.
                </p>
                <div className="text-left max-w-2xl mx-auto mt-4">
                  <ul className="list-disc pl-5 text-gray-600 space-y-2">
                    <li>
                    ...
                    <li>
                      Provide templates and standards for research content
                      creation
                    </li>
                    <li>
            ...
            <div className="mt-8 text-center">
              <p className="mb-6 text-gray-700 max-w-2xl mx-auto">
                Our 2027 launch will be shaped by collaborative input from
                experts across fields. Join the Nerd community today to
                influence the development of tomorrow's research tools.
              </p>
              <a
