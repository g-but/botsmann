  ...
  return (
    <div className="my-16">
      ...
      <p className="text-gray-600 text-center mb-12 max-w-3xl mx-auto">
        Our AI Research Assistant combines powerful features to transform how you collect, organize,
        and generate insights from your research.
      </p>
      ...
      <div className="text-center">
        <p className="text-gray-600 mb-6">
          Designed for researchers by researchers, our AI assistant adapts to your unique
          needs—whether you're an academic, journalist, student, or industry professional.
        </p>
