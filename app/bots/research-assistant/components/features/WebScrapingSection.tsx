    ...
    <div className="my-24">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-700 text-lg mb-12">
          Stay at the cutting edge of your research field with automated updates
          from trusted sources, filtered and prioritized based on your specific
          interests.
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16 items-start">
          <div>
            ...
            <p className="text-gray-700 mb-6">
              Our AI research assistant continuously monitors key sources in
              your field, identifying new publications, breakthroughs, and
              discussions relevant to your specific research focus.
            </p>
          ...
          <div>
            ...
            <p className="text-gray-700 mb-6">
              We monitor a wide range of sources to ensure you have complete
              coverage of developments in your field, from formal academic
              publications to cutting-edge discussions on social media.
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div>
              ...
              <p className="text-sm text-gray-600">
                Set up custom keywords and phrases to ensure you only receive
                updates that matter to your specific research focus.
              </p>
            </div>
            <div>
              <div className="w-12 h-12 bg-indigo-100 rounded-full flex items-center justify-center mb-4">
              ...
              <p className="text-sm text-gray-600">
                Identify emerging trends in your field before they become
                mainstream, giving you a competitive edge in research.
              </p>
            </div>
            <div>
              <div className="w-12 h-12 bg-indigo-100 rounded-full flex items-center justify-center mb-4">
              ...
              <p className="text-sm text-gray-600">
                Filter sources by academic credibility, citation count, and
                peer-review status to ensure quality information.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-600 mb-4">
            Stop manually checking dozens of sources. Let our AI assistant bring
            the latest research directly to you, precisely filtered to match
            your interests.
          </p>
        </div>
      </div>
