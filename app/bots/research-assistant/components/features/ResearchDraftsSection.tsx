        ...
        <div className={styles.featureFooter}>
          ...
          <ol className={styles.workflowSteps}>
            <li>
              ...
              <span className={styles.stepText}>Upload your research materials and sources</span>
            </li>
            <li>
              <span className={styles.stepNumber}>2</span>
              <span className={styles.stepText}>Select the type of content you need</span>
            </li>
            <li>
              <span className={styles.stepNumber}>3</span>
              <span className={styles.stepText}>Provide specific focus or requirements</span>
            </li>
            <li>
              <span className={styles.stepNumber}>4</span>
              <span className={styles.stepText}>Review, edit, and export your research draft</span>
            </li>
          </ol>
        </div>
      </div>
