    ...
    <div className="my-24">
      <div className="mb-8 text-center">
        ...
        <p className="text-gray-700 max-w-3xl mx-auto">
          Nerd helps you transform your unstructured notes, voice recordings,
          and casual musings into well-structured, publication-ready research
          content with proper formatting and citations.
        </p>
      </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white p-5 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600 text-sm">
                Record your thoughts and ideas as voice memos, and Nerd converts
                them into structured research outlines and drafts.
              </p>
            </div>
            <div className="bg-white p-5 rounded-lg shadow-sm">
              <h4 className="font-medium text-lg mb-2">Research Reports</h4>
              <p className="text-gray-600 text-sm">
                Transform raw data and analysis into structured reports with
                methodology sections, findings, and discussion points that
            ...
            <div className="bg-white p-5 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600 text-sm">
                Generate comprehensive literature reviews that synthesize
                findings across multiple sources with consistent formatting and
                proper attribution.
              </p>
            </div>
          </div>
      ...
      <div className="mt-10">
        ...
        <div className="text-center">
          <p className="text-gray-700 mb-6 max-w-2xl mx-auto">
            Our AI-powered draft generation significantly reduces the time spent
            on formatting and structuring, allowing you to focus on refining the
            content and developing your ideas.
          </p>
