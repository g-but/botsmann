...
const ResearchSystemSection: React.FC = () => {
  ...
  const organizationCategories = [
    ...
    { name: "By Relevance", description: "Prioritize based on importance to your core research", icon: "⭐" },
  ...
  return (
    <div className="my-24 bg-research-gradient p-10 rounded-2xl">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-3xl font-bold text-gray-900 mb-4">Automated Research Systematization</h2>
        <p className="text-gray-700 text-lg mb-8">
          Transform your scattered research materials into a well-organized, searchable knowledge base
          that helps you find exactly what you need, when you need it.
        </p>

        <div className="grid md:grid-cols-2 gap-10 mb-16 items-center">
          <div>
            <h3 className="text-xl font-semibold text-gray-900 mb-4">Upload Once, Organize Automatically</h3>
            <p className="text-gray-700 mb-4">
              Simply upload your research materials in any format. Our AI system will automatically extract key information,
              identify themes, tag content, and create a structured database tailored to your research needs.
            </p>
            ...
            <div className="h-60 overflow-hidden relative">
              ...
              <div className="space-y-3">
                <div className="p-2 border-l-4 border-blue-400 bg-blue-50">
                  ...
                  <div className="text-sm font-medium">Grover's Algorithm: Applications in Database Search</div>
                  <div className="text-xs text-gray-500">Source: arXiv:2103.12345 • Added: Mar 15, 2023</div>
                </div>
                <div className="p-2 border-l-4 border-purple-400 bg-purple-50">
                  ...
                  <div className="text-sm font-medium">Quantum Supremacy: Theoretical Foundations</div>
                  <div className="text-xs text-gray-500">Source: Science Journal • Added: Feb 28, 2023</div>
                </div>
                <div className="p-2 border-l-4 border-green-400 bg-green-50">
                  ...
                  <div className="text-xs text-gray-500">Source: Nature Physics • Added: Apr 10, 2023</div>
                </div>
                <div className="p-2 border-l-4 border-red-400 bg-red-50">
                  ...
                  <div className="text-sm font-medium">Topological Quantum Error Correction Codes</div>
                  <div className="text-xs text-gray-500">Source: Personal Notes • Added: May 5, 2023</div>
                </div>
              </div>
            </div>
        ...
        <div className="mb-10">
          <h3 className="text-xl font-semibold text-gray-900 mb-4">Multiple Organization Systems</h3>
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-600 mb-4">
            Focus on your research, not on managing files. Our system handles the organization
            so you can concentrate on generating insights and making discoveries.
          </p>
        </div>
      </div>
    </div>
