...
const DiscoverySection: React.FC = () => {
  ...
  const researchDomains: ResearchDomain[] = [
    ...
    },
    {
      ...
      description: 'Developing new materials with novel properties for technological applications.',
      insights: [
    ...
    <section className="my-24">
      ...
      <div className={styles.container}>
            ...
            <div className={styles.discoveryVisual}>
              <div className={styles.visualPlaceholder}>
                <div className={styles.connectionGraph}>
                  ...
                  <div className={styles.graphNode} style={{ top: '20%', left: '30%' }}></div>
                  <div className={styles.graphNode} style={{ top: '60%', left: '20%' }}></div>
        ...
        <div className={styles.discoveryMethodology}>
          ...
          <div className={styles.methodologyGrid}>
            <div className={styles.methodologyItem}>
              ...
              <h4>Gap Analysis</h4>
              <p>Systematically identifies unexplored areas within and between research fields</p>
            </div>
            <div className={styles.methodologyItem}>
              <div className={styles.methodologyIcon}>
                <span>2</span>
              ...
              <p>Detects meaningful patterns across disparate research domains</p>
            </div>
            <div className={styles.methodologyItem}>
              <div className={styles.methodologyIcon}>
                <span>3</span>
              ...
              <p>Suggests novel connections between seemingly unrelated concepts</p>
            </div>
            <div className={styles.methodologyItem}>
              <div className={styles.methodologyIcon}>
                <span>4</span>
              ...
              <p>Creates testable hypotheses based on identified gaps and connections</p>
            </div>
          </div>
        </div>
        ...
        <div className={styles.discoveryCallToAction}>
          ...
          <button className={styles.primaryButton}>Launch Discovery Mode</button>
        </div>
      </div>
    </section>
  );
