  ...
  const events = [
    {
      ...
      description: "Practice Swiss German with locals in a relaxed setting with guided conversation topics.",
    ...
    },
    {
      ...
      description: "Great opportunity to hear Swiss German in context and meet locals who share your interests.",
