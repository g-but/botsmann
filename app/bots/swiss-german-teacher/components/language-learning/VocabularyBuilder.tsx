  ...
  const examples = [
    {
      ...
      notes: "Formal greeting, singular form. Use 'grüezi mitenand' for greeting multiple people."
    },
    {
      standard: "auf Wiedersehen",
      swiss: "uf widerluege",
      pronunciation: "oof VEE-der-loo-eh-geh",
      notes: "More formal goodbye. For casual situations use 'tschüss' or 'tschau'."
    },
    {
      standard: "danke",
      swiss: "merci",
      pronunciation: "MER-see",
      notes: "Swiss German often uses French-derived words for common expressions."
    }
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg p-4 border border-gray-200">
        <div className="flex justify-between items-start">
          <div>
            <div className="flex items-center mb-1">
              <h4 className="font-medium text-lg text-gray-900">{examples[activeExample].swiss}</h4>
              <span className="ml-2 text-sm text-gray-500">({examples[activeExample].standard})</span>
            </div>
            <p className="text-sm text-gray-600 mb-3">Pronunciation: {examples[activeExample].pronunciation}</p>
          </div>
        ...
        <div className="bg-gray-50 p-3 rounded-md mb-2">
          <p className="text-sm text-gray-700">
            <span className="font-medium">Context:</span> {examples[activeExample].notes}
          </p>
        </div>
      ...
      <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
        <h4 className="font-medium text-gray-900 mb-2">Build your vocabulary</h4>
