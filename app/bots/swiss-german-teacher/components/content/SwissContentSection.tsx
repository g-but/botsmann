...
const SwissContentSection: React.FC = () => {
  return (
    <section
      id="swiss-content"
      className="mb-24 pb-6 pt-6 px-6 bg-amber-50 rounded-xl border border-amber-100"
    >
      ...
      <p className="text-lg text-gray-600 mb-8 ml-14">
        Enhance your learning with authentic Swiss German content curated to match your proficiency
        level.
      </p>

      <div className="p-8 bg-white rounded-xl shadow-sm border border-gray-200 relative">
        <p className="text-lg text-gray-600 mb-6">
          Our team is currently developing a rich library of content to help you immerse yourself in
          Swiss German language and culture.
        </p>
