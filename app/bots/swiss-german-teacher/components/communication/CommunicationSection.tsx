...
const EmailGenerator = dynamic(() => import("./EmailGenerator"), {
  ssr: false,
  loading: () => (
    <div className="h-60 bg-gray-100 rounded-lg animate-pulse"></div>
  ),
});
  ...
  return (
    ...
    >
      ...
      <p className="text-lg text-gray-600 mb-8 ml-14">
        Learn to communicate effectively in Swiss German for everyday
        situations, from professional emails to casual text messages.
      </p>

      <div id="email-examples" className={`${cardStyle} mb-10`}>
        <h3 className="text-xl font-semibold mb-2">Email Writing</h3>
        <p className="mb-4">
          Generate professional or casual emails that follow cultural norms and
          use appropriate expressions, or get help responding to German emails
          you've received.
        </p>
        ...
        <div className="space-y-4">
          <div className="bg-white p-3 rounded-md text-sm mb-4 shadow-sm">
            ...
            <p className="text-gray-600 italic">
              ...
              <br />
              Ich schreibe Ihnen bezüglich der Wohnungsbesichtigung am kommenden
              Donnerstag.
              <br />
            ...
            <p className="text-xs text-gray-500 mt-1">
              *Heidi noted: This formal structure follows the standard format
              used by native German speakers in professional contexts.
            </p>
          </div>
          <div className="bg-white p-3 rounded-md text-sm shadow-sm">
            ...
            <p className="text-xs text-gray-500 mt-1">
              *Heidi noted: I've used the Zürich dialect forms you've been
              practicing, avoiding the Basel expressions you frequently confused
              in our sessions.
            </p>
            <p className="text-xs text-gray-400 mt-1">
              Translation: Hi Ms. Meier, I'm writing about the apartment viewing
              on Thursday. Would it be possible to move it to 6 PM? Thanks a lot
      ...
      <div id="texting-examples" className={`${cardStyle} mb-10`}>
        ...
        <p className="mb-4">
          Master everyday Swiss German texting with dialect-appropriate casual
          expressions, or get help understanding messages you've received.
        </p>
