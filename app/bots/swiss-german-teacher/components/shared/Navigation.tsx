...
const Navigation = ({ getTryLink, className = "" }: NavigationProps) => {
  ...
  return (
    <nav
      className={`sticky top-0 z-50 w-full transition-all duration-300 ${isScrolled ? "bg-white shadow-md" : "bg-transparent"} ${className}`}
    >
        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <div className="flex-shrink-0 flex items-center">
              ...
              >
                <path
                  d="M12 3C9.5 3 7.37 4.69 6.54 6.97C5.88 6.92 5.44 7.27 5.24 7.68C5.04 8.08 4.84 8.76 5.43 9.4C4.61 10.5 4 11.35 4 13C4 13.24 4.03 13.47 4.07 13.7L2 19L5 19.5L6.5 19L8 20H16L17.5 19L19 19.5L22 19L19.93 13.7C19.97 13.47 20 13.24 20 13C20 11.35 19.39 10.5 18.57 9.4C19.16 8.76 18.96 8.08 18.76 7.68C18.56 7.27 18.12 6.92 17.46 6.97C16.63 4.69 14.5 3 12 3Z"
                  fill="currentColor"
                />
                <path
                  d="M8.5 12.5C8.5 11.672 7.828 11 7 11C6.172 11 5.5 11.672 5.5 12.5C5.5 13.328 6.172 14 7 14C7.828 14 8.5 13.328 8.5 12.5Z"
                  fill="white"
                />
                <path
                  d="M18.5 12.5C18.5 11.672 17.828 11 17 11C16.172 11 15.5 11.672 15.5 12.5C15.5 13.328 16.172 14 17 14C17.828 14 18.5 13.328 18.5 12.5Z"
                  fill="white"
                />
              </svg>
