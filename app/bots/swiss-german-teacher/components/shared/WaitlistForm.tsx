...
const WaitlistForm = () => {
  const { formState, updateEmail, togglePreference, handleSubmit } =
    useWaitlistForm();
    ...
    return (
      <div className="bg-green-50 rounded-lg p-6 border border-green-200 text-center">
        ...
        <p className="text-gray-600">
          You've been added to our waitlist. We'll notify you when we have
          updates about the features you're interested in.
        </p>
      </div>
    );
  }
            ...
            <div key={key} className="flex items-start">
              <div className="flex items-center h-5">
                <input
                  ...
                  onChange={() =>
                    togglePreference(key as keyof WaitlistPreferences)
                  }
