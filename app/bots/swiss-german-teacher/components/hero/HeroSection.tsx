      ...
      <div className="absolute inset-0 bg-gradient-to-br from-green-50 to-blue-50 z-0">
        ...
        >
          <g clipPath="url(#clip0_104_39)">
            <path
              d="M375.374 111.208L389.856 125.69"
              stroke="#047857"
              strokeWidth="0.5"
              strokeLinecap="round"
            ></path>
            <path
              d="M361.64 125.69L389.856 153.905"
              stroke="#047857"
              strokeWidth="0.5"
              strokeLinecap="round"
            ></path>
            <path
              d="M346.409 140.173L389.856 183.62"
              stroke="#047857"
              strokeWidth="0.5"
              strokeLinecap="round"
            ></path>
            <path
              d="M332.675 155.402L389.856 212.582"
              stroke="#047857"
              strokeWidth="0.5"
              strokeLinecap="round"
            ></path>
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start space-y-8 md:space-y-0 md:space-x-12 max-w-7xl mx-auto">
          ...
          <div className="md:w-1/2 flex-shrink-0">
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-6">
              A personalized AI language tutor that helps you learn Swiss German
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start">
                ...
                <p className="text-gray-700">
                  Learn <strong>real</strong> Swiss German as it's actually
                  spoken
                </p>
              </div>
              <div className="flex items-start">
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              ...
              <button
                onClick={() =>
                  document
                    .getElementById("language-learning")
          ...
          <div className="md:w-1/2 flex-shrink-0 relative">
              ...
              <div className="p-4 max-h-[500px] overflow-y-auto">
                <div className="flex mb-4">
                  ...
                  <div className="bg-gray-100 rounded-lg p-3 max-w-[90%]">
                    <p className="text-gray-800">
                      Grüezi! I'm Heidi, your Swiss German teacher. How can I
                      help you today?
                    </p>
                  </div>
                </div>
                <div className="flex justify-end mb-4">
                  <div className="bg-green-100 rounded-lg p-3 max-w-[90%] mr-3">
                    <p className="text-gray-800">
                      I'm planning a trip to Zürich and want to learn some basic
                ...
                <div className="flex mb-4">
                  ...
                  <div className="bg-gray-100 rounded-lg p-3 max-w-[90%]">
                    <p className="text-gray-800 mb-2">
                      That's exciting! Here are some useful everyday phrases in
                      Swiss German (Zürich dialect):
                    </p>
                    <ul className="space-y-2 text-gray-800">
                      <li>
                        <strong>Grüezi</strong> - Hello (formal)
                      </li>
                      <li>
                        <strong>Hoi</strong> - Hi (informal)
                      </li>
                      <li>
                        <strong>Merci vilmal</strong> - Thank you very much
                      </li>
                      <li>
                        <strong>Uf Widerluege</strong> - Goodbye
                      </li>
                      <li>
                        <strong>Wie gaht's?</strong> - How are you?
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <div className="absolute -bottom-4 -left-4 bg-white rounded-lg p-4 shadow-md border border-gray-200 max-w-[220px]">
              ...
              <p className="text-sm text-gray-600">
                "Heidi helped me learn Swiss German when standard German courses
                weren't working for me. So practical!"
              </p>
