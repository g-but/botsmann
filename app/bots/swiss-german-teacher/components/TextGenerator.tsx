...
export default function TextGenerator({ getTryLink }: TextGeneratorProps) {
  ...
  const [conversation, setConversation] = useState<
    { type: "user" | "contact" | "bot"; text: string; time?: string }[]
  >([
    {
      type: "contact",
      text: "Sali! Hesch lust hüt abig öppis z'esse?",
      time: "19:30",
    },
  ]);
  ...
  const handleExampleClick = (example: string) => {
    ...
    if (example === "What does this mean?") {
      setConversation([
        ...
        {
          type: "user",
          text: "I don't understand. What does this mean?",
          time: "19:45",
        },
      ]);
      setIsTyping(true);
...
"Sali! Ja gern, wo wotsch go? 😊"`,
      ...
      setConversation([
        {
          type: "contact",
          text: "Treffe mer üs morn am Bahnhof um 18:00?",
          time: "14:22",
        },
      ]);
  ...
  const handleSendMessage = () => {
    ...
    if (activeExample === "What does this mean?") {
      setConversation((prev) => [
        ...
        {
          type: "user",
          text: "Sali! Ja gern, wo wotsch go? 😊",
          time: "19:47",
        },
      ]);
      setTimeout(() => {
        setConversation((prev) => [
          ...
          {
            type: "contact",
            text: "Super! Villicht ins Hiltl? Um 20:30?",
            time: "19:50",
          },
        ]);
      }, 1500);
      ...
      <div className="bg-gray-100 p-3 h-96 overflow-y-auto flex flex-col space-y-3">
        ...
        {conversation.map((msg, index) => (
          ...
          >
            ...
            >
              {msg.type === "bot" && (
                <p className="text-gray-800 font-medium">Heidi Bot:</p>
              )}
              <p className={msg.type === "bot" ? "whitespace-pre-line" : ""}>
                {msg.text}
              </p>
              {msg.time && (
                <p
