    ...
    const welcomeMessages: Message[] = [
      {
        ...
        senderAvatar: '🤖',
        content:
          "Welcome to your secure data room! I've analyzed your case and organized all documents. Your lawyer has been notified.",
      ...
      },
      {
        ...
        content:
          "Hi! I've reviewed your case documents. I have a few questions about the contract you uploaded. Can we discuss?",
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <span
                  className={`w-2 h-2 rounded-full ${lawyerOnline ? 'bg-green-400 animate-pulse' : 'bg-gray-400'}`}
                />
            ...
            <div className="flex-1 overflow-y-auto p-3 sm:p-4 space-y-3 sm:space-y-4">
              {messages.map((message) => (
                ...
                >
                  ...
                  <div
                    className={`flex-1 max-w-[80%] sm:max-w-[70%] ${message.sender === 'user' ? 'items-end' : ''}`}
                  >
                    ...
                    <div
                      className={`rounded-xl px-3 sm:px-4 py-2 sm:py-3 text-sm ${
                        message.sender === 'user'
        ...
        {activeTab === 'timeline' && (
          <div className="p-3 sm:p-4 space-y-4">
            {[
              {
                time: '2 min ago',
                event: 'Lawyer joined the data room',
                icon: '👨‍⚖️',
                color: 'blue',
              },
