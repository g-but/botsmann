...
import { ViewMode, CategoryWithFiles } from '../utils';
...
export const OverviewView: React.FC<OverviewViewProps> = ({
  ...
  <div className="space-y-6 animate-fadeIn">
    ...
    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
      {[
        { icon: '📁', title: 'Files', count: files.length, color: 'from-blue-500 to-cyan-500', view: 'files' as ViewMode },
        { icon: '💬', title: 'Chat', count: '24/7', color: 'from-purple-500 to-pink-500', view: 'chat' as ViewMode },
        { icon: '📅', title: 'Timeline', count: 'Live', color: 'from-green-500 to-emerald-500', view: 'timeline' as ViewMode },
        { icon: '⚙️', title: 'Settings', count: 'Manage', color: 'from-orange-500 to-red-500', view: 'settings' as ViewMode }
      ].map((action) => (
        <button
          key={action.title}
