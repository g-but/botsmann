  ...
  return (
    <div className="my-16" id="features">
      ...
      <p className="text-gray-600 text-center mb-12 max-w-3xl mx-auto">
        Build a private AI node that keeps your confidential documents secure
        while providing powerful legal insights.
      </p>
        ...
        {features.map((f, idx) => (
          ...
          >
            ...
            {expanded === idx && (
              <div className="mt-4 pt-4 border-t border-blue-100 animate-fadeIn">
                <p className="text-gray-700 text-sm">
                  Securely deployed for individuals, lawyers, or entire firms
            ...
            <div className="text-blue-600 text-sm mt-3 flex items-center">
              ...
              <svg
                className={`w-4 h-4 ml-1 transition-transform ${expanded === idx ? "rotate-180" : ""}`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
