    ...
    <section className="mb-20" id="vision">
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-gray-600 max-w-4xl mx-auto">
          We're on a multi-year journey to transform legal services through AI. We believe in
          building responsibly, transparently, and with the legal community—not against it.
        </p>
      </div>
      ...
      <div className="mb-16 bg-gradient-to-br from-slate-900 to-slate-800 rounded-2xl p-10 text-white shadow-2xl border border-slate-700">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg leading-relaxed text-slate-100 mb-6">
            To democratize access to justice through AI while enhancing—not replacing—the expertise
            of legal professionals. We're building a future where AI handles routine legal tasks,
            freeing lawyers to focus on complex reasoning, client relationships, and strategic
            thinking.
          </p>
          <div className="grid md:grid-cols-3 gap-6 mt-8">
            <div className="bg-slate-800/50 rounded-lg p-6 border border-slate-600">
              ...
              <p className="text-sm text-slate-300">
                Open about capabilities, limitations, and development progress
              </p>
            </div>
            <div className="bg-slate-800/50 rounded-lg p-6 border border-slate-600">
              <div className="text-3xl mb-3">🤝</div>
              ...
              <p className="text-sm text-slate-300">
                Built with input from legal professionals and researchers
              </p>
            </div>
            <div className="bg-slate-800/50 rounded-lg p-6 border border-slate-600">
              <div className="text-3xl mb-3">🔒</div>
              ...
              <p className="text-sm text-slate-300">
                Privacy-first, bias-aware, and human-overseen
              </p>
            </div>
          </div>
        </div>
            ...
            <div key={index} className="relative">
              ...
              <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-200">
                <div className="md:flex">
                  {/* Icon Section */}
                  <div
                    className={`md:w-24 bg-gradient-to-br ${phase.color} p-8 flex items-center justify-center`}
                  >
                    ...
                    <div className="flex flex-wrap items-start justify-between gap-4 mb-4">
                      <div>
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <span
                            className={`px-3 py-1 rounded-full text-xs font-medium ${phase.statusColor}`}
                          >
                            {phase.status}
                          </span>
                        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <div>
            ...
            <p className="text-gray-700 text-sm">
              Legal services are expensive and inaccessible to many. AI can help democratize legal
              assistance, making basic legal help available to everyone while keeping lawyers
          ...
          <div>
            ...
            <p className="text-gray-700 text-sm">
              Lawyers spend 30-40% of their time on routine tasks. AI assistance can free them to
              focus on strategy, negotiation, and client relationships—the truly human aspects of
              law.
            </p>
          </div>
          <div>
            ...
            <p className="text-gray-700 text-sm">
              AI judges can help reduce bias and inconsistency in routine decisions, while humans
              maintain oversight for complex judgments requiring empathy and discretion.
            </p>
          </div>
          <div>
            <h4 className="font-semibold text-gray-900 mb-3 flex items-center gap-2">
