  ...
  return (
    <div className="min-h-screen bg-white">
      <main className="mx-auto max-w-screen-xl px-6 py-16">
        ...
        <div className="mt-16">
          <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
            <h2 className="mb-4 text-2xl font-semibold text-gray-900">Ready to Transform Your Legal Practice?</h2>
            <p className="mb-6 text-gray-600">
              Leverage our AI-powered legal expert assistant to streamline research,
              analyze documents, and stay current with legal developments.
            </p>
            <Link
              href="/about"
              className="inline-flex items-center justify-center rounded-md bg-openai-green px-4 py-2 text-sm font-medium text-white hover:bg-opacity-90"
