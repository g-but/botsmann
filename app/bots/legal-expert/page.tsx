...
export default function LegalExpert() {
  ...
  const featureItems = [
    { title: 'Legal Research', description: 'Search statutes and case law with precision.', icon: '📚' },
    { title: 'Document Analysis', description: 'Understand contracts and legal briefs instantly.', icon: '📄' },
    { title: 'Case Law Insights', description: 'Surface relevant precedents for your matter.', icon: '💡' },
    { title: 'Regulatory Compliance', description: 'Check requirements across jurisdictions.', icon: '✅' },
    { title: 'Contract Review', description: 'Highlight risks and missing clauses automatically.', icon: '✍️' },
  ];
