...
export const ProjectPlanTab: FC = () => (
  <div className="animate-fadeIn">
    ...
    <div className="bg-gray-50 p-4 rounded-lg mb-4">
      ...
      <p className="text-gray-700 mb-3">
        The User Authentication System will provide secure identity verification, role-based access
        control, and seamless integration with third-party OAuth providers for the Cursor
        application.
      </p>
            ...
            <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {RESOURCE_ALLOCATIONS.map((resource) => (
