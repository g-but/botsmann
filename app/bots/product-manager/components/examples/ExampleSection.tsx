                  ...
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      <div className="bg-blue-50 p-3 rounded-md">
                        <p className="text-sm font-semibold text-gray-800">Planning & Requirements (2 weeks)</p>
                        <p className="text-xs text-gray-600 mt-1">Define user flows, security requirements, and integration points</p>
                      </div>
                    </div>
                  </div>
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      <div className="bg-blue-50 p-3 rounded-md">
                        <p className="text-sm font-semibold text-gray-800">Core Authentication (3 weeks)</p>
                        <p className="text-xs text-gray-600 mt-1">Implement user registration, login, and session management</p>
                      </div>
                    </div>
                  </div>
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      <div className="bg-blue-50 p-3 rounded-md">
                        <p className="text-sm font-semibold text-gray-800">OAuth Integration (2 weeks)</p>
                        <p className="text-xs text-gray-600 mt-1">Add support for Google, GitHub, and Microsoft authentication</p>
                      </div>
                    </div>
                  </div>
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      <div className="bg-blue-50 p-3 rounded-md">
                        <p className="text-sm font-semibold text-gray-800">Role-Based Access Control (2 weeks)</p>
                        <p className="text-xs text-gray-600 mt-1">Implement permission system with role hierarchy</p>
                      </div>
                    </div>
                  </div>
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      <div className="bg-blue-50 p-3 rounded-md">
                        <p className="text-sm font-semibold text-gray-800">Testing & Refinement (1 week)</p>
                        <p className="text-xs text-gray-600 mt-1">Security testing, performance optimization, and bug fixes</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    <tr>
                      <td className="px-4 py-2 text-sm text-gray-900">Backend Developer</td>
                      <td className="px-4 py-2 text-sm text-gray-500">2 FTE</td>
                      <td className="px-4 py-2 text-sm text-gray-500">All Phases</td>
                    </tr>
                    <tr>
                      <td className="px-4 py-2 text-sm text-gray-900">Frontend Developer</td>
                      <td className="px-4 py-2 text-sm text-gray-500">1 FTE</td>
                      <td className="px-4 py-2 text-sm text-gray-500">Phase 2-4</td>
                    </tr>
                    <tr>
                      <td className="px-4 py-2 text-sm text-gray-900">Security Engineer</td>
                      <td className="px-4 py-2 text-sm text-gray-500">0.5 FTE</td>
                      <td className="px-4 py-2 text-sm text-gray-500">Phase 1, 5</td>
                    </tr>
                    <tr>
                      <td className="px-4 py-2 text-sm text-gray-900">QA Engineer</td>
                      <td className="px-4 py-2 text-sm text-gray-500">1 FTE</td>
                      <td className="px-4 py-2 text-sm text-gray-500">Phase 5</td>
                    </tr>
                  </tbody>
                </table>
              </div>
      ...
      <div className="space-y-4">
        <div className="bg-gray-50 p-4 rounded-lg">
          ...
          <p className="text-gray-700 mb-2">
            The authentication system will use a microservice architecture to ensure scalability and maintainability.
          </p>
          <div className="bg-white p-3 rounded border border-gray-200">
            <div className="flex flex-col items-center">
              ...
              <svg className="h-8 w-8 text-gray-400 my-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <div className="flex items-center">
                  ...
                  <span className="text-sm font-medium text-gray-700">Node.js with Express</span>
                </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center">
                  ...
                  <span className="text-sm font-medium text-gray-700">React with Next.js</span>
                </div>
                <p className="text-xs text-gray-600 pl-8">
                  Server-side rendering improves security for authentication flows
                </p>
              </div>
              <div className="space-y-2">
                <div className="flex items-center">
                ...
                <p className="text-xs text-gray-600 pl-8">
                  Reliable, ACID-compliant database with excellent support for JSON data
                </p>
              </div>
              <div className="space-y-2">
                <div className="flex items-center">
                  ...
                  <span className="text-sm font-medium text-gray-700">JWT with Refresh Tokens</span>
                </div>
                <p className="text-xs text-gray-600 pl-8">
          ...
          <div className="bg-white p-3 rounded border border-gray-200">
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center">
                ...
                <span className="font-medium text-gray-900">User Registration Flow</span>
              </div>
            ...
            <div className="pl-8">
              ...
              <div className="space-y-1">
                <div className="flex items-center">
                  ...
                  <span className="text-xs text-gray-700">Create registration API endpoint</span>
                </div>
                <div className="flex items-center">
                  <div className="w-4 h-4 rounded-sm border border-gray-300 mr-2 flex-shrink-0"></div>
                  <span className="text-xs text-gray-700">Implement email verification service</span>
                </div>
                <div className="flex items-center">
                  <div className="w-4 h-4 rounded-sm border border-gray-300 mr-2 flex-shrink-0"></div>
                  <span className="text-xs text-gray-700">Build registration form UI with validation</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-3 rounded border border-gray-200">
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center">
                ...
                <span className="font-medium text-gray-900">Login & Session Management</span>
              </div>
              <div className="px-2 py-0.5 rounded-full bg-yellow-100 text-yellow-800 text-xs">
                8 Story Points
              </div>
            ...
            <div className="pl-8">
              ...
              <div className="space-y-1">
                <div className="flex items-center">
                  <div className="w-4 h-4 rounded-sm border border-gray-300 mr-2 flex-shrink-0"></div>
                  <span className="text-xs text-gray-700">Implement login API with rate limiting</span>
                </div>
                <div className="flex items-center">
                  <div className="w-4 h-4 rounded-sm border border-gray-300 mr-2 flex-shrink-0"></div>
                  <span className="text-xs text-gray-700">Create JWT token generation and validation</span>
                </div>
                <div className="flex items-center">
                  <div className="w-4 h-4 rounded-sm border border-gray-300 mr-2 flex-shrink-0"></div>
                  <span className="text-xs text-gray-700">Design and implement refresh token flow</span>
                </div>
                <div className="flex items-center">
                  <div className="w-4 h-4 rounded-sm border border-gray-300 mr-2 flex-shrink-0"></div>
                  <span className="text-xs text-gray-700">Build login UI with form validation</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-3 rounded border border-gray-200">
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center">
                ...
                <span className="font-medium text-gray-900">Password Management</span>
              </div>
              <div className="px-2 py-0.5 rounded-full bg-yellow-100 text-yellow-800 text-xs">
                5 Story Points
              </div>
            ...
            <div className="pl-8">
              ...
              <div className="space-y-1">
                <div className="flex items-center">
                  <div className="w-4 h-4 rounded-sm border border-gray-300 mr-2 flex-shrink-0"></div>
                  <span className="text-xs text-gray-700">Create password reset flow with tokens</span>
                </div>
                <div className="flex items-center">
                  <div className="w-4 h-4 rounded-sm border border-gray-300 mr-2 flex-shrink-0"></div>
                  <span className="text-xs text-gray-700">Implement password change functionality</span>
                </div>
                <div className="flex items-center">
                  <div className="w-4 h-4 rounded-sm border border-gray-300 mr-2 flex-shrink-0"></div>
                  <span className="text-xs text-gray-700">Build password reset and change UI</span>
                </div>
              </div>
            </div>
          </div>
  ...
  "oauthProviders": [
    {
      ...
      <div className="bg-gray-50 p-4 rounded-lg">
        ...
        <div className="space-y-3">
          <div className="bg-white p-3 rounded border border-gray-200">
            <div className="font-medium text-gray-900 mb-1">Security Best Practices</div>
          ...
          <div className="bg-white p-3 rounded border border-gray-200">
            <div className="font-medium text-gray-900 mb-1">Performance Considerations</div>
            <ul className="text-sm text-gray-600 space-y-1 list-disc pl-5">
          ...
          <div className="bg-white p-3 rounded border border-gray-200">
            <div className="font-medium text-gray-900 mb-1">Testing Strategy</div>
            <ul className="text-sm text-gray-600 space-y-1 list-disc pl-5">
    ...
    <section id="examples" className="scroll-mt-24 my-16">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-gray-600 text-center mb-12 max-w-3xl mx-auto">
          Explore how Trident creates comprehensive project plans and technical guidance for Cursor development, helping you build better software faster.
        </p>
