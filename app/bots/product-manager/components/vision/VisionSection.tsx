          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
              ...
              <p className="text-gray-600">
                Cursor represents a new era of AI-augmented development, but its potential is only
                fully realized when paired with equally advanced product management practices.
              </p>
            </div>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
              ...
              <p className="text-gray-600 mb-4">
                ...
                strategic partner that anticipates needs, identifies optimization opportunities, and
                helps teams ship better products faster.
              </p>
              <p className="text-gray-600">
                Our goal is to establish a new standard for AI-assisted product management, where
                machines handle the repetitive tasks while humans focus on creative problem-solving
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
              ...
              <p className="text-gray-600">
                ...
                completeness, and team satisfaction to ensure we're delivering real value to the
                Cursor community.
              </p>
            </div>
          </div>
