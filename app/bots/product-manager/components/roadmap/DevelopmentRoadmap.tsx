  ...
  const roadmapItems = [
    {
      ...
      description: 'Establishing the foundational architecture and core project management capabilities',
      items: [
    ...
    },
    {
      ...
      description: 'Enhancing project management tools and documentation generation',
      items: [
    ...
    },
    {
      ...
      description: 'Expanding to enterprise needs and building a developer ecosystem',
      items: [
  ...
  return (
    <div className="py-16">
      <div className="text-center mb-12">
        <h2 className="text-3xl font-bold text-gray-900 mb-4">Trident Development Roadmap</h2>
        <p className="max-w-3xl mx-auto text-gray-600">
          Our vision for evolving Trident into the ultimate product management solution for Cursor development.
        ...
        <div className="relative z-10">
          {roadmapItems.map((item, index) => (
            <div key={index} className="mb-12 relative">
              <div className={`absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-5 h-5 rounded-full border-4 
