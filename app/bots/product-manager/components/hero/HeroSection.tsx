        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="md:pr-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              ...
              <Link href="#features" className="inline-flex items-center justify-center px-6 py-3 border border-gray-300 text-base font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 shadow-sm transition-all duration-150 ease-in-out">
                Explore Features
              </Link>
            </div>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  <h3 className="text-sm font-semibold text-gray-900">What Trident can do for you:</h3>
                  <ul className="mt-2 space-y-1 text-sm text-gray-500">
                    <li className="flex items-center">
                      <svg className="mr-1.5 h-3 w-3 text-blue-500" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="relative">
            <div className="bg-white p-6 rounded-xl shadow-md border border-gray-200 relative z-10">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-xs text-gray-500">Project Management Assistant</p>
                  </div>
                </div>
              ...
              <div className="bg-gray-50 rounded-lg p-4 mb-4 border border-gray-200">
                <h4 className="text-sm font-medium text-gray-900 mb-2">Feature Development Plan</h4>
                <div className="space-y-3">
                  <div className="flex items-center">
                    <div className="w-6 h-6 rounded-full bg-blue-100 text-blue-800 flex items-center justify-center text-xs mr-3">1</div>
                    <div className="flex-1 h-2 bg-blue-500 rounded"></div>
                  </div>
                  <div className="flex items-center">
                    <div className="w-6 h-6 rounded-full bg-blue-100 text-blue-800 flex items-center justify-center text-xs mr-3">2</div>
                    <div className="flex-1 h-2 bg-blue-500 rounded"></div>
                  </div>
                  <div className="flex items-center">
                    <div className="w-6 h-6 rounded-full bg-blue-100 text-blue-800 flex items-center justify-center text-xs mr-3">3</div>
                    <div className="flex-1 h-2 bg-blue-500 rounded"></div>
                  </div>
                  <div className="flex items-center">
                    <div className="w-6 h-6 rounded-full bg-gray-100 text-gray-500 flex items-center justify-center text-xs mr-3">4</div>
                    <div className="flex-1 h-2 bg-gray-200 rounded"></div>
                  </div>
                  <div className="flex items-center">
                    <div className="w-6 h-6 rounded-full bg-gray-100 text-gray-500 flex items-center justify-center text-xs mr-3">5</div>
                    <div className="flex-1 h-2 bg-gray-200 rounded"></div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-indigo-50 rounded-lg p-4 mb-4 border border-indigo-100">
                <h4 className="text-sm font-medium text-indigo-900 mb-2">Technical Strategy</h4>
                <ul className="space-y-2 text-sm">
                  <li className="flex items-start">
                    <svg className="mt-0.5 mr-2 h-4 w-4 text-indigo-500" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path>
                    </svg>
                    <span className="text-indigo-800">Component architecture defined</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="mt-0.5 mr-2 h-4 w-4 text-indigo-500" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path>
                    </svg>
                    <span className="text-indigo-800">API integration strategy outlined</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="mt-0.5 mr-2 h-4 w-4 text-indigo-500" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path>
                    </svg>
                    <span className="text-indigo-800">Performance optimizations identified</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-3">
                ...
                <div className="mt-2 relative">
                  <div className="h-2 bg-gray-200 rounded-full">
                    <div className={`absolute top-0 left-0 h-2 bg-blue-600 rounded-full ${isAnimating ? 'animate-pulse' : ''}`} style={{ width: '60%' }}></div>
                  </div>
                </div>
              </div>
