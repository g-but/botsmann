      ...
      <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
        <div>
          ...
          <p className="text-lg md:text-xl text-gray-700 mb-6">
            Your personal AI health companion, offering evidence-based guidance
          ...
          <div className="flex flex-wrap gap-3 md:gap-4">
            ...
            <a href="#features" className="btn-secondary px-5 py-3 text-base">
              Explore Features
            </a>
          </div>
          ...
          <div className="space-y-3">
            <div className="bg-white p-3 rounded-lg shadow-sm ml-auto max-w-[85%]">
              <p className="text-gray-800 text-sm md:text-base">
                I'm here to provide evidence-based health guidance. How can I
                assist with your health journey today?
              </p>
            </div>
            <div className="bg-green-50 p-3 rounded-lg shadow-sm max-w-[85%]">
              <p className="text-gray-800 text-sm md:text-base">
                I'd like to improve my energy levels during the day. Any
                suggestions?
              </p>
            </div>
            <div className="bg-white p-3 rounded-lg shadow-sm ml-auto max-w-[85%]">
              <p className="text-gray-800 text-sm md:text-base">
                Improving energy levels involves several factors: optimizing
                sleep quality, balanced nutrition with steady blood sugar,
                regular physical activity, proper hydration, and stress
                management...
              </p>
            </div>
          </div>
