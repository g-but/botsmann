 ...
 */
const PatientFeaturesSection: React.FC<PatientFeaturesSectionProps> = ({
  features,
  getTryLink,
}) => {
  return (
    <div className="my-16">
      <h2 className="text-3xl font-bold text-gray-900 mb-4 text-center">
        For Patients: AI-Powered Health Guidance
      </h2>
      <p className="text-gray-600 text-center mb-12 max-w-3xl mx-auto">
        Imhotep provides personalized health information, advice, and tools to
        help you achieve your optimal health.
      </p>
