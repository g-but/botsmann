  ...
  const roadmapItems = [
    {
      ...
      description:
        "Initial release of Imhotep with core health information capabilities and personalized guidance.",
      timeframe: "2024",
      icon: "🚀",
      completed: true,
    },
    ...
    },
    {
      ...
      description:
        "Integrated platform for health products, supplements, and services recommended by Imhotep.",
      timeframe: "2027",
      icon: "🏪",
      completed: false,
    },
    {
      ...
      description:
        "Expanding access to underserved communities worldwide with localized health guidance.",
      timeframe: "2028",
      icon: "🌎",
      completed: false,
    },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <div className="max-w-3xl mx-auto">
            <p className="text-lg text-gray-700 mb-6">
              Imhotep represents a fundamental reimagining of healthcare
              delivery—making evidence-based health guidance accessible to
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="bg-blue-50 p-5 rounded-lg">
                ...
                <p className="text-gray-600">
                  Making world-class medical knowledge available to everyone
              ...
              <div className="bg-green-50 p-5 rounded-lg">
                ...
                <p className="text-gray-600">
                  Shifting from reactive disease treatment to proactive health
              ...
              <div className="bg-purple-50 p-5 rounded-lg">
                ...
                <p className="text-gray-600">
                  Moving beyond one-size-fits-all guidance to truly
            ...
            <p className="text-gray-700">
              We believe healthcare should be continuous, not episodic. By
              combining AI with the latest medical research, we're creating a
              system that guides health decisions, monitors progress, and adapts
              to changing conditions—all while working alongside traditional
          ...
          <div className="md:hidden">
            <div className="space-y-8">
              {roadmapItems.map((item, index) => (
                <div
                  key={index}
                  className="border-l-4 border-green-200 pl-4 relative"
                >
                  <div
                    className="absolute -left-3 top-0 w-6 h-6 rounded-full flex items-center justify-center shadow-sm"
                    style={{
                      backgroundColor: item.completed ? "#34D399" : "#D1FAE5",
                    }}
                  >
        ...
        <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-6 md:p-8">
          ...
          <p className="text-gray-700 mb-8 max-w-3xl mx-auto text-center">
            We're building a collaborative community of engineers, medical
            researchers, and healthcare experts working together to create the
            next generation of AI-powered healthcare solutions.
          </p>
          ...
          <div className="mb-10">
            ...
            {applicationType === "developer" && (
              <div className="space-y-4 bg-white rounded-lg p-6 shadow-sm">
                ...
                <p className="text-gray-700">
                  Join our engineering community to build cutting-edge AI
                  systems that make healthcare more accessible and effective.
                </p>
                <div className="text-left max-w-2xl mx-auto mt-4">
                  <ul className="list-disc pl-5 text-gray-600 space-y-2">
                    <li>
                      Contribute to AI models for medical information processing
                    </li>
                    <li>
                      Build intuitive, accessible interfaces for health
                      management
                    </li>
                    <li>Work on our open-source healthcare components</li>
                    <li>
                      Design data visualization for complex health metrics
                    </li>
                    <li>
                      Collaborate on architecture for secure health data systems
                    </li>
                  </ul>
                </div>
              </div>
            ...
            {applicationType === "medical" && (
              <div className="space-y-4 bg-white rounded-lg p-6 shadow-sm">
                ...
                <p className="text-gray-700">
                  Partner with us to bridge the gap between cutting-edge medical
                  research and practical AI applications.
                </p>
                <div className="text-left max-w-2xl mx-auto mt-4">
                  <ul className="list-disc pl-5 text-gray-600 space-y-2">
                    <li>
                      Help validate and improve our health recommendation
                      algorithms
                    </li>
                    <li>
                      Contribute to research on AI-assisted health interventions
                    </li>
                    <li>
                      Design studies to measure efficacy of digital health
                      solutions
                    </li>
                    <li>
                      Work with engineers to translate research into practical
                      features
                    </li>
                    <li>
                      Help prioritize evidence-based medicine in our approaches
                    </li>
                  </ul>
                </div>
              </div>
            ...
            {applicationType === "operations" && (
              <div className="space-y-4 bg-white rounded-lg p-6 shadow-sm">
                ...
                <p className="text-gray-700">
                  Lend your clinical expertise to ensure our solutions integrate
                  seamlessly with healthcare workflows.
                </p>
                <div className="text-left max-w-2xl mx-auto mt-4">
                  <ul className="list-disc pl-5 text-gray-600 space-y-2">
                    <li>
                      Advise on how AI can best support clinical decision-making
                    </li>
                    <li>Help design patient education content and protocols</li>
                    <li>
                      Share insights on healthcare delivery challenges and
                      opportunities
                    </li>
                    <li>
                      Contribute to ethical frameworks for AI healthcare
                      applications
                    </li>
                    <li>
                      Test and provide feedback on our health guidance features
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="mt-8 text-center">
              <p className="mb-6 text-gray-700 max-w-2xl mx-auto">
                Together, we can create healthcare tools that combine the best
                of human expertise with the power of AI. Join our open
                collaboration community to help shape the future of healthcare.
              </p>
              <a
