      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <div className="max-w-3xl mx-auto">
            <p className="text-lg text-gray-700 mb-6">
              Imhotep represents a fundamental reimagining of healthcare delivery—making
              evidence-based health guidance accessible to everyone, everywhere, at any time.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="bg-blue-50 p-5 rounded-lg">
                ...
                <p className="text-gray-600">
                  Making world-class medical knowledge available to everyone regardless of location
                  or economic status.
                </p>
              </div>
              ...
              <div className="bg-green-50 p-5 rounded-lg">
                ...
                <p className="text-gray-600">
                  Shifting from reactive disease treatment to proactive health optimization and
                  prevention.
                </p>
              </div>
              ...
              <div className="bg-purple-50 p-5 rounded-lg">
                ...
                <p className="text-gray-600">
                  Moving beyond one-size-fits-all guidance to truly individualized health protocols.
                </p>
              </div>
            </div>

            <p className="text-gray-700">
              We believe healthcare should be continuous, not episodic. By combining AI with the
              latest medical research, we're creating a system that guides health decisions,
              monitors progress, and adapts to changing conditions—all while working alongside
        ...
        <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-6 md:p-8">
          ...
          <p className="text-gray-700 mb-8 max-w-3xl mx-auto text-center">
            We're building a collaborative community of engineers, medical researchers, and
            healthcare experts working together to create the next generation of AI-powered
          ...
          <div className="mb-10">
            ...
            {applicationType === 'developer' && (
              <div className="space-y-4 bg-white rounded-lg p-6 shadow-sm">
                ...
                <p className="text-gray-700">
                  Join our engineering community to build cutting-edge AI systems that make
            ...
            {applicationType === 'medical' && (
              <div className="space-y-4 bg-white rounded-lg p-6 shadow-sm">
                ...
                <p className="text-gray-700">
                  Partner with us to bridge the gap between cutting-edge medical research and
            ...
            {applicationType === 'operations' && (
              <div className="space-y-4 bg-white rounded-lg p-6 shadow-sm">
                ...
                <p className="text-gray-700">
                  Lend your clinical expertise to ensure our solutions integrate seamlessly with
            ...
            <div className="mt-8 text-center">
              <p className="mb-6 text-gray-700 max-w-2xl mx-auto">
                Together, we can create healthcare tools that combine the best of human expertise
                with the power of AI. Join our open collaboration community to help shape the future
                of healthcare.
              </p>
              <a
