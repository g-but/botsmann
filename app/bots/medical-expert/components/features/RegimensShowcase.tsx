  ...
  return (
    <div>
      ...
      <p className="text-gray-600 mb-6">
        Structured protocols tailored to your health goals, time availability, and budget. Compare
        different approaches and receive AI-customized recommendations.
      </p>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="bg-blue-50 p-6 rounded-lg">
          ...
          <p className="text-gray-600 mb-4">
            Blueprint is Bryan Johnson's comprehensive anti-aging protocol designed to optimize
            biological systems:
          </p>
        ...
        <div className="bg-purple-50 p-6 rounded-lg">
          ...
          <p className="text-gray-600 mb-4">Custom-designed health regimens based on your:</p>
          <ul className="list-disc pl-5 text-gray-600 mb-4 space-y-1">
          ...
          <p className="text-sm text-gray-500 mt-4">
            Imhotep analyzes thousands of research papers to create evidence-based protocols that
      ...
      <div className="text-center mt-8">
        <p className="text-gray-600 mb-1">
          Coming 2026: Full AI-powered regimen customization with supplement delivery and wearable
          integration
        </p>
      </div>
    </div>
