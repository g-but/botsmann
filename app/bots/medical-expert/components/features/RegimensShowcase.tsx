  ...
  return (
    <div>
      ...
      <p className="text-gray-600 mb-6">
        Structured protocols tailored to your health goals, time availability,
        and budget. Compare different approaches and receive AI-customized
        recommendations.
      </p>

      <div className="mb-8">
        <h4 className="text-lg font-semibold mb-3 text-purple-700">
          Compare Health Approaches
        </h4>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="bg-blue-50 p-6 rounded-lg">
          ...
          <p className="text-gray-600 mb-4">
            Blueprint is Bryan Johnson's comprehensive anti-aging protocol
            designed to optimize biological systems:
          </p>
        ...
        <div className="bg-purple-50 p-6 rounded-lg">
          <h4 className="text-lg font-semibold mb-3 text-purple-700">
            Imhotep's AI Personalized Protocol
          </h4>
          <p className="text-gray-600 mb-4">
          ...
          <p className="text-sm text-gray-500 mt-4">
            Imhotep analyzes thousands of research papers to create
            evidence-based protocols that fit your life, not the other way
            around.
          </p>
        </div>
      </div>
      ...
      <div className="text-center mt-8">
        <p className="text-gray-600 mb-1">
          Coming 2026: Full AI-powered regimen customization with supplement
          delivery and wearable integration
        </p>
      </div>
    </div>
  );
