      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-center mb-12">
          ...
          <div className="md:w-1/2">
            ...
            <p className="text-gray-700 mb-4">
              MedBox revolutionizes healthcare by bringing clinical diagnostics into your home.
              Using microfluidics, lab-on-chip technology, and AI analysis, MedBox enables you to
              perform tests that once required hospital visits and expensive lab equipment.
            </p>
            <ul className="space-y-2 mb-6">
              <li className="flex items-start">
                <span className="text-green-600 mr-2 mt-1">✓</span>
                <span className="text-gray-700">
                  Run comprehensive lab tests from your home with minimal training
                </span>
              </li>
              <li className="flex items-start">
                <span className="text-green-600 mr-2 mt-1">✓</span>
                <span className="text-gray-700">
                  AI automatically analyzes results and alerts physicians when needed
                </span>
              </li>
              <li className="flex items-start">
                <span className="text-green-600 mr-2 mt-1">✓</span>
              ...
              <li className="flex items-start">
                <span className="text-green-600 mr-2 mt-1">✓</span>
                <span className="text-gray-700">
                  Healthcare providers receive organized, analyzed data for review
                </span>
              </li>
            </ul>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-white p-6 rounded-xl shadow-md">
            ...
            <p className="text-gray-700 mb-4">
              MedBox can perform these lab tests with just a small blood sample, which would
              typically require a clinic visit, lab processing, and days of waiting.
            </p>
        ...
        <div className="bg-gradient-to-r from-blue-100 to-green-100 p-6 rounded-lg shadow-sm border border-gray-200">
          ...
          <p className="text-gray-700 mb-4 text-center">
            MedBox is bringing laboratory-grade diagnostics into your home, democratizing access to
            high-quality health monitoring and reducing dependence on in-person medical visits. With
            AI analysis and physician oversight, this represents the next evolution in preventative
            healthcare.
          </p>
