  ...
  return (
    <section id="features" className="my-16 scroll-mt-24">
      ...
      <p className="text-gray-600 text-center mb-8 max-w-3xl mx-auto">
        Imhotep offers these powerful tools to help you manage your health more effectively. Click
        on each feature to learn more.
      </p>
      ...
      <div className="mt-16">
        ...
        <p className="text-gray-600 text-center mb-8 max-w-3xl mx-auto">
          We're working on these exciting features to make healthcare even more personalized and
          convenient.
        </p>
