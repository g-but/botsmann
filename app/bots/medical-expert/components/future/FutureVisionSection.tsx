  ...
  return (
    <section id="future-vision" className="my-16 scroll-mt-24">
      ...
      <p className="text-gray-600 text-center mb-12 max-w-3xl mx-auto">
        Our step-by-step plan to make Dr. Imhotep the most comprehensive health
        assistant, bringing advanced health monitoring and personalized care to
        everyone.
      </p>
      ...
      <div className="mt-16 bg-green-50 p-8 rounded-xl border border-green-100">
        ...
        <div className="prose prose-lg max-w-none text-gray-700">
          <p>
            We're creating a comprehensive health ecosystem that makes
            preventative healthcare accessible to everyone. Dr. Imhotep will
            evolve into a health companion that makes maintaining optimal health
            effortless.
          </p>
          <p>
            The MedBox will provide a collection of health monitoring devices
            for tracking biomarkers, allowing you to optimize your health with
            precision like health pioneers such as Bryan Johnson.
          </p>
          <p>
            Our marketplace will connect you with health regimens, supplements,
            and healthcare professionals when needed. We'll also offer
            subscription services for medications and supplements, making it
            easier to stay consistent with your health protocols.
          </p>
          <p>
            Through a combination of AI, biomarker tracking, and optional human
            expertise, we'll make preventative healthcare both accessible and
            personalized, helping you achieve optimal health with less effort.
          </p>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm">
          ...
          <p className="text-gray-700 mb-4">
            Our Health Marketplace will connect users with everything they need
            to maintain optimal health: supplements formulated for specific
            health goals, medical devices for home monitoring, medications with
            automatic refills, and direct access to healthcare professionals.
          </p>
