      ...
      <div className="max-w-screen-xl mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Solon's versatile platform adapts to governance needs across various
            levels of government and specialized jurisdictions.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="mb-6 text-gray-600">
              Local governments can implement direct democracy for enhancing
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="mb-6 text-gray-600">
              State governments can leverage the platform for broader policy
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="mb-6 text-gray-600">
              National governments can provide unprecedented transparency
              through integrated oversight systems.
            </p>
            <ul className="mb-6 space-y-3 text-gray-600">
              <li className="flex items-start">
                <svg
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="mb-6 text-gray-600">
              Special jurisdictions can optimize service delivery through
              targeted governance modules.
            </p>
            <ul className="mb-6 space-y-3 text-gray-600">
              <li className="flex items-start">
                <svg
          ...
          <div className="flex flex-col sm:flex-row items-center">
            <div className="sm:w-2/3 mb-6 sm:mb-0 sm:pr-8">
              ...
              <p className="text-gray-600">
                Every governmental entity has unique needs. Our team works with
                you to implement a custom Solon solution designed for your
                specific governance context, legal requirements, and community
                needs.
              </p>
            </div>
