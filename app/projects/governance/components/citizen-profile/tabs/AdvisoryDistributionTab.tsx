...
import { AdvisoryDistribution } from '../types';

interface AdvisoryDistributionTabProps {
...
export const AdvisoryDistributionTab: React.FC<AdvisoryDistributionTabProps> = ({
