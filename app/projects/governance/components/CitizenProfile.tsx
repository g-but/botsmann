...
const CitizenProfile: React.FC<CitizenProfileProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<
    "overview" | "tax" | "benefits" | "advisory"
  >("overview");
  const [advisoryDistribution, setAdvisoryDistribution] = useState<
  ...
  const handleDistributionChange = (agencyId: string, value: number) => {
    ...
    const newTotal = updatedDistribution.reduce(
      (sum, item) => sum + item.advisoryPercentage,
      0,
    );
  ...
  const submitAdvisoryDistribution = () => {
    alert(
      "Tax distribution preferences submitted! (This is an advisory recommendation only)",
    );
    setHasChanges(false);
  };
        ...
        {activeTab === "overview" && (
          <div>
            ...
            <div className="mt-8 mb-4">
              ...
              <p className="mt-1 text-sm text-gray-500">
                How your tax contributions are currently allocated across
                agencies.
              </p>
            </div>
                  ...
                  <div className="flex justify-between items-start">
                    ...
                    <span
                      className={`px-2 py-0.5 text-xs font-medium rounded-full ${
                        contribution.transparencyScore >= 90
                          ? "bg-green-100 text-green-800"
                          : contribution.transparencyScore >= 70
                            ? "bg-blue-100 text-blue-800"
                            : contribution.transparencyScore >= 50
                ...
                <div className="flex">
                  ...
                  <div className="ml-3 flex-1 md:flex md:justify-between">
                    <p className="text-sm text-blue-700">
                      Need help understanding your tax payments? Contact a tax
                      ...
                      <div className="mt-2 sm:flex sm:justify-between">
                        <div className="sm:flex">
                          <p className="flex items-center text-sm text-gray-500">
                            <span>Provider: </span>
                            <a
                              href={`/projects/governance/agencies/${benefit.providerId}`}
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    ...
                    <div className="mt-2 text-sm text-green-700">
                      <p>
                        You may be eligible for 3 additional benefits based on
                        your profile. Click below to explore your options.
                      </p>
                    </div>
                    <div className="mt-4">
                      <div className="-mx-2 -my-1.5 flex">
                        <button
                          type="button"
                          className="bg-green-100 px-3 py-1.5 rounded-md text-sm font-medium text-green-800 hover:bg-green-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
                        >
                          Check Eligibility
                        </button>
                      </div>
        ...
        {activeTab === "advisory" && (
          <div>
            <div className="mb-6">
              ...
              <p className="mt-1 text-sm text-gray-500">
                Indicate how you would like your tax contributions to be
                allocated across agencies.
                <strong className="text-blue-800 ml-2 font-semibold">
                  This is advisory only and does not change your actual tax
                  allocation.
                </strong>
              </p>
            </div>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-yellow-700">
                    <p>
                      Your preferences will be recorded and shared with
                      policymakers, but actual budget allocations are determined
                      through the democratic process. This feedback helps
