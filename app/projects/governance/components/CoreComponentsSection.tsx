  ...
  const components = [
    {
      ...
      description:
        'Track and verify every government transaction with complete transparency. Our blockchain-based system ensures all financial activities are immutable, traceable, and publicly accessible.',
      features: [
    ...
    },
    {
      ...
      description:
        'Measure and track the effectiveness of legislation with our innovative framework. Every law is tied to specific, measurable outcomes that can be monitored in real-time.',
      features: [
    ...
    },
    {
      ...
      description:
        'A decentralized marketplace for government services. Connect citizens with service providers through smart contracts and automated verification.',
      features: [
    ...
    },
    {
      ...
      description:
        'Secure, verifiable, and accessible voting system for all government decisions. Built on blockchain technology for maximum transparency and trust.',
      features: [
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center mb-4">
                ...
                <h3 className="ml-4 text-2xl font-bold text-gray-900">{activeComponent.name}</h3>
              </div>

              <p className="text-lg text-gray-600 mb-6">{activeComponent.description}</p>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="space-y-4">
                {activeComponent.stats.map((stat, index) => (
                  <div key={index} className="flex items-center justify-between">
                    ...
                    <span
                      className={`text-xl font-bold text-${activeComponent.id === 'transparency' ? 'green' : activeComponent.id === 'law' ? 'blue' : activeComponent.id === 'marketplace' ? 'orange' : 'purple'}-600`}
                    >
                      {stat.value}
                    </span>
                  </div>
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                <h4 className="text-lg font-semibold text-gray-900 mb-2">Example Applications</h4>
