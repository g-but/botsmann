  ...
  const faqs: FAQItem[] = [
    ...
    },
    {
      ...
      answer: (
        <div>
          <p className="mb-2">
            Solon's blockchain implementation ensures transaction security through multiple
            mechanisms:
          </p>
          ...
          <p className="mt-2">
            This approach prevents fraud, unauthorized spending, and provides real-time verification
            of all government financial activities.
          </p>
        </div>
      ),
      category: 'technical',
    },
    {
      ...
      answer: (
        <div>
          <p className="mb-2">Solon's platform is built on a modern technology stack including:</p>
          <ul className="list-disc pl-5 space-y-1">
    ...
    },
    {
      ...
      answer: (
        <p>
          ...
          <br />
          <br />
          <span className="font-medium">Small municipalities (under 50,000 residents):</span> 3-6
          months for initial deployment, with full functionality within 12 months.
          <br />
          <br />
          <span className="font-medium">Medium municipalities (50,000-250,000):</span> 6-9 months
          for initial deployment, with full functionality within 18 months.
          <br />
          <br />
          <span className="font-medium">Large municipalities (over 250,000):</span> 9-12 months for
    ...
    },
    {
      ...
      answer: (
        <div>
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li>
              <span className="font-medium">Administrative staff:</span> Basic platform navigation,
              transaction input, and reporting (1-2 days)
            </li>
            <li>
              <span className="font-medium">Financial officers:</span> Advanced transaction
              management, budget oversight, and audit trails (2-3 days)
            </li>
            <li>
              <span className="font-medium">IT personnel:</span> System maintenance, security
              protocols, and integration with existing systems (3-5 days)
            </li>
            <li>
              <span className="font-medium">Department heads:</span> KPI management, performance
              tracking, and marketplace utilization (2 days)
            </li>
            <li>
              <span className="font-medium">Elected officials:</span> Platform overview, policy
              implementation, and citizen engagement (1 day)
            </li>
          </ul>
          <p className="mt-2">
            We also provide ongoing support, regular refresher courses, and a comprehensive
            knowledge base.
          </p>
        </div>
      ),
    ...
    },
    {
      ...
      answer: (
        <div>
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li>
              <span className="font-medium">Procurement costs:</span> 20-30% reduction through
              increased competition and transparency
            </li>
            <li>
              <span className="font-medium">Administrative overhead:</span> 15-25% reduction through
              automation and streamlined processes
            </li>
            <li>
              <span className="font-medium">Fraud prevention:</span> 60-80% reduction in fraudulent
              transactions and misappropriation
            </li>
            <li>
              <span className="font-medium">Service delivery:</span> 25-40% improved cost efficiency
              through marketplace competition
            </li>
            <li>
              <span className="font-medium">Tax compliance:</span> 10-15% increase due to greater
    ...
    },
    {
      ...
      answer: (
        <p>
          ...
          <br />
          <br />
          <span className="font-medium">SaaS subscription:</span> Annual subscription based on
          population size, starting at $0.50 per citizen annually for basic features, with premium
          features available.
          <br />
          <br />
          <span className="font-medium">Perpetual license:</span> One-time purchase with ongoing
          ...
          <br />
          <br />
          <span className="font-medium">Open source community:</span> Core components are available
            ...
            >
              ...
              {expandedId === faq.id && (
                <div className="px-6 pb-5 text-gray-600">
                  <div className="pt-3 border-t border-gray-200">{faq.answer}</div>
                </div>
              )}
            </div>
          ))}
