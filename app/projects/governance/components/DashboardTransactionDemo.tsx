...
interface DashboardTransactionDemoProps {
  filter?: string;
}

/**
 * Interactive transaction demo component specifically for the citizen dashboard
 * that allows citizens to engage with government transactions and supports filtering
 */
const DashboardTransactionDemo: React.FC<DashboardTransactionDemoProps> = ({ filter = 'all' }) => {
  // Sample transaction data with categories
  const [transactions, setTransactions] = useState<Transaction[]>([
    {
      ...
      details:
        'Emergency repair of damaged highway section including asphalt replacement, line repainting, and drainage improvements.',
    ...
    },
    {
      ...
      details:
        'Quarterly maintenance of Central Community Park including lawn care, tree pruning, playground equipment inspection, and irrigation system maintenance.',
      category: 'recreation',
      district: 'north',
      likes: 134,
      dislikes: 8,
    ...
    },
    {
      ...
      details:
        'Purchase of 500 laptops, 50 interactive whiteboards, and supporting infrastructure for the Western School District technology modernization initiative.',
      category: 'education',
      district: 'west',
      likes: 201,
      dislikes: 115,
  ...
  const filteredTransactions =
    filter === 'all'
      ...
      : transactions.filter(
          (tx) =>
            tx.category?.toLowerCase() === filter.toLowerCase() ||
            tx.district?.toLowerCase() === filter.toLowerCase(),
        );
  ...
  const handleCommentSubmit = (id: string) => {
    ...
    setTransactions((prev) =>
      prev.map((tx) => (tx.id === id ? { ...tx, comments: [...tx.comments, newComment] } : tx)),
    );
  ...
  const handleDonate = (id: string, target: 'agency' | 'recipient') => {
    ...
    alert(
      `Thank you for supporting ${entity}! This would open a donation form in a real implementation.`,
    );
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-gray-600">
        Explore and engage with government transactions. Your participation helps ensure
      ...
      {filteredTransactions.length > 0 ? (
          ...
          >
            ...
            <div className="px-6 py-4">
              <div className="flex flex-col space-y-3">
                ...
                <p className="text-sm text-gray-600 pt-2">{transaction.details}</p>
              </div>
                ...
                <div className="mt-4 pt-3 border-t border-gray-100">
                  ...
                  <div className="flex">
                    <input
                      ...
                      onChange={(e) =>
                        setCommentInputs((prev) => ({ ...prev, [transaction.id]: e.target.value }))
                      }
        ...
        <div className="text-center py-8 bg-white rounded-lg border border-gray-200">
          ...
          <p className="text-gray-500 max-w-md mx-auto">
            No transactions matching your current filter were found. Try adjusting your filters or
            check back later.
          </p>
        </div>
      )}
...
export default DashboardTransactionDemo;
