        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1 animate-fadeIn">
            <h1 className="text-5xl font-bold text-gray-900 mb-4 leading-tight">
              <span className="text-green-600">Solon</span> — Decentralized Direct Democracy
            </h1>
            <p className="text-xl text-gray-600 mb-8">
              Redefining governance through maximum transparency, direct citizen participation, 
              and market-based efficiency. A revolution in democratic systems for the 21st century.
            </p>
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="flex items-center">
                ...
                <div>
                  <h3 className="text-lg font-medium text-gray-900">100% Transparent</h3>
                  <p className="text-sm text-gray-500">Public transactions & votes</p>
                </div>
              </div>
              <div className="flex items-center">
                <div className="flex-shrink-0 h-12 w-12 rounded-full bg-green-100 flex items-center justify-center mr-3">
                ...
                <div>
                  <h3 className="text-lg font-medium text-gray-900">Citizen Powered</h3>
                  <p className="text-sm text-gray-500">Direct participation in decisions</p>
                </div>
              </div>
              <div className="flex items-center">
                <div className="flex-shrink-0 h-12 w-12 rounded-full bg-green-100 flex items-center justify-center mr-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">KPI-based governance models</p>
                </div>
              </div>
            </div>
          </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h3 className="text-lg font-medium text-gray-900 mb-2 flex items-center">
                      <span className="flex-shrink-0 w-6 h-6 flex items-center justify-center rounded-full bg-green-100 text-green-700 mr-2">1</span>
                      Transparency
                    </h3>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h3 className="text-lg font-medium text-gray-900 mb-2 flex items-center">
                      <span className="flex-shrink-0 w-6 h-6 flex items-center justify-center rounded-full bg-green-100 text-green-700 mr-2">2</span>
                      Outcome Measurement
                    </h3>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h3 className="text-lg font-medium text-gray-900 mb-2 flex items-center">
                      <span className="flex-shrink-0 w-6 h-6 flex items-center justify-center rounded-full bg-green-100 text-green-700 mr-2">3</span>
                    ...
                    <p className="text-gray-600 ml-8">
                      ...
                      government perform the function, with an open marketplace for competitive bidding.
                    </p>
                  </div>
                </div>
              </div>
