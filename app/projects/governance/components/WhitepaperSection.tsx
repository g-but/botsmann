      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="mt-2 text-xl text-gray-600 max-w-3xl mx-auto">
            Detailed technical documentation and theoretical foundations of our
            revolutionary governance platform.
          </p>
        </div>
                    ...
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center">
                      <div className="mb-4 sm:mb-0">
                        ...
                        <div className="flex items-center mt-1">
                          ...
                          <span className="px-2 py-1 text-xs font-medium text-green-600 bg-green-100 rounded ml-2">
                            EPUB
                          </span>
                        </div>
                      </div>
