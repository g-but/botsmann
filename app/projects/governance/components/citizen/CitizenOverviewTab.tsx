...
import {
  formatCurrency,
  getTransparencyScoreClasses,
  getTransparencyBarClasses,
...
export const CitizenOverviewTab: FC<CitizenOverviewTabProps> = ({ citizen }) => {
  return (
    <div>
      <div className="mb-6">
        ...
        {citizen.contributions.map((contribution) => (
          ...
          >
            <div className="flex justify-between items-start">
              ...
              <span
                className={`px-2 py-0.5 text-xs font-medium rounded-full ${getTransparencyScoreClasses(contribution.transparencyScore)}`}
              >
            ...
            <div className="mt-2">
              ...
              <div className="w-full bg-gray-200 rounded-full h-2">
                <div
                  className={`h-2 rounded-full ${getTransparencyBarClasses(contribution.transparencyScore)}`}
