...
export const CitizenBenefitsTab: FC<CitizenBenefitsTabProps> = ({ benefits }) => {
  return (
    <div>
      <div className="mb-6">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <p className="ml-2 flex-shrink-0 flex">
                      <span
                        className={`px-2 py-0.5 text-xs font-medium rounded-full ${getStatusBadgeClasses(benefit.status)}`}
                      >
                        {benefit.status}
                      </span>
                    </p>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-green-700">
                <p>
                  You may be eligible for 3 additional benefits based on your profile. Click below
