          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center mt-1">
              <div className={`h-2 w-full rounded-full ${
                transaction.transparencyScore >= 90 ? 'bg-green-500' :
                transaction.transparencyScore >= 70 ? 'bg-blue-500' :
                transaction.transparencyScore >= 50 ? 'bg-yellow-500' :
                'bg-red-500'
              }`}>
                <div
              ...
              <span className="ml-2 text-sm font-medium text-gray-900">{transaction.transparencyScore}/100</span>
            </div>
          </div>
          <div className="flex flex-col">
                      ...
                      <div className="relative flex space-x-3">
                        <div>
                          <span className={`h-8 w-8 rounded-full flex items-center justify-center ring-8 ring-white ${
                            index === transaction.timeline.length - 1 ? 'bg-green-500' : 'bg-blue-500'
                          }`}>
