...
const RoadmapSection: React.FC = () => {
  const roadmapItems = [
    ...
    },
    {
      ...
      description: 'Building the bidding system for government functions, KPI tracking infrastructure, and contract management system.',
      timeline: 'Q3-Q4 2024'
    },
    {
      phase: 'Phase 3',
      title: 'Advanced Features',
      description: 'Integration of AI-powered analytics for corruption detection, predictive modeling, and existing government systems.',
      timeline: 'Q1-Q2 2025'
    },
    {
      phase: 'Phase 4',
      title: 'Scale and Expand',
      description: 'Adding multi-language support, customization for different levels of government, and third-party API ecosystem.',
        ...
        <div className="mt-12 bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="md:w-2/3">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Adoption Metrics</h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-lg font-medium text-gray-900">Citizen Participation</h4>
                    <p className="text-gray-600">Target: 40% of eligible citizens actively voting within first year</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full bg-green-100 text-green-600 mr-3 flex-shrink-0">
                  ...
                  <div>
                    <h4 className="text-lg font-medium text-gray-900">Cost Efficiency</h4>
                    <p className="text-gray-600">Target: 15-20% reduction in administrative costs in first 2 years</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full bg-green-100 text-green-600 mr-3 flex-shrink-0">
                  ...
                  <div>
                    <h4 className="text-lg font-medium text-gray-900">Trust in Government</h4>
                    <p className="text-gray-600">Target: 60% approval rating within communities (up from average 35%)</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full bg-green-100 text-green-600 mr-3 flex-shrink-0">
                  ...
                  <div>
                    <h4 className="text-lg font-medium text-gray-900">Law Effectiveness</h4>
                    <p className="text-gray-600">Target: 75% of laws meeting defined KPIs by year 3</p>
                  </div>
                </div>
              </div>
            </div>
