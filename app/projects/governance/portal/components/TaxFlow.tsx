    ...
    <div>
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
        <div>
          ...
          <p className="mt-1 text-gray-500">
            See how your $3,200 in annual taxes is allocated across government
            services
          </p>
        </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6">
        ...
        <div className="mt-6 border-t border-gray-200 pt-4 text-sm text-gray-500">
          <p>
            Note: Visualization represents FY 2023-2024 tax allocations. Future
            visualizations will include interactive Sankey diagrams.
          </p>
        </div>
      </div>
