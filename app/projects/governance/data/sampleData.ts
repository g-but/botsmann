    ...
    documents: [
      {
        ...
        url: "/documents/tx1/contract.pdf",
      },
      {
        id: "doc2",
        name: "Environmental Impact",
        url: "/documents/tx1/impact.pdf",
      },
      {
        id: "doc3",
        name: "Completion Certificate",
        url: "/documents/tx1/completion.pdf",
      },
    ],
    timeline: [
      {
      ...
      },
      {
        ...
        description: "5 contractors submitted bids",
      },
      {
        date: "2023-03-20",
        event: "Contract Awarded",
        description: "Metro Construction selected",
      },
      {
        date: "2023-04-15",
    ...
    documents: [
      {
        ...
        url: "/documents/tx2/specs.pdf",
      },
      {
        id: "doc5",
        name: "School Distribution Plan",
        url: "/documents/tx2/distribution.pdf",
      },
      {
        id: "doc6",
        name: "Training Schedule",
        url: "/documents/tx2/training.pdf",
      },
    ],
    timeline: [
      {
  ...
  },
  {
    ...
    documents: [
      { id: "doc7", name: "Design Plans", url: "/documents/tx3/design.pdf" },
      {
        ...
        url: "/documents/tx3/feedback.pdf",
      },
      {
        id: "doc9",
        name: "Sustainability Report",
        url: "/documents/tx3/sustainability.pdf",
      },
    ],
    timeline: [
      {
    ...
    documents: [
      {
        ...
        url: "/documents/tx4/strategy.pdf",
      },
      {
        id: "doc11",
        name: "Cold Chain Verification",
        url: "/documents/tx4/coldchain.pdf",
      },
      {
        id: "doc12",
        name: "Community Access Points",
        url: "/documents/tx4/access.pdf",
      },
    ],
    timeline: [
      {
    ...
    documents: [
      {
        id: "doc13",
        name: "Equipment Specifications",
        url: "/documents/tx5/specs.pdf",
      },
      {
        id: "doc14",
        name: "Training Certification",
        url: "/documents/tx5/training.pdf",
      },
      {
        id: "doc15",
        name: "Deployment Plan",
        url: "/documents/tx5/deployment.pdf",
      },
    ],
    timeline: [
      {
...
export const sampleRegulations: AgencyRegulation[] = [
  {
    ...
    status: "active",
    purpose:
      "To ensure timely emergency service response to all areas of the jurisdiction.",
    kpis: [
      {
  ...
  },
  {
    ...
    status: "active",
    purpose:
      "To ensure consistent quality in road construction and maintenance projects.",
    kpis: [
      {
  ...
  },
  {
    ...
    status: "active",
    purpose:
      "To standardize technology implementation and ensure equal access across all schools.",
    kpis: [
      {
  ...
  },
  {
    ...
    status: "active",
    purpose:
      "To establish clear protocols for responding to public health emergencies.",
    kpis: [
      {
...
export const sampleAgencies: AgencyData[] = [
  {
    ...
    transactions: sampleTransactions.filter(
      (t) => t.department === "Public Safety",
    ),
    regulations: sampleRegulations.filter(
      (r) =>
        r.enablingLawName.includes("Emergency") ||
        r.enablingLawName.includes("First Responder"),
    ),
  ...
  },
  {
    ...
    transactions: sampleTransactions.filter(
      (t) => t.department === "Transportation",
    ),
    regulations: sampleRegulations.filter((r) =>
      r.enablingLawName.includes("Infrastructure"),
    ),
  ...
  },
  {
    ...
    transactions: sampleTransactions.filter(
      (t) => t.department === "Education",
    ),
    regulations: sampleRegulations.filter((r) =>
      r.enablingLawName.includes("Education"),
    ),
  ...
  },
  {
    ...
    transactions: sampleTransactions.filter(
      (t) => t.department === "Parks & Recreation",
    ),
    regulations: sampleRegulations.filter((r) =>
      r.enablingLawName.includes("Public Spaces"),
    ),
  ...
  },
  {
    ...
    transactions: sampleTransactions.filter(
      (t) => t.department === "Public Health",
    ),
    regulations: sampleRegulations.filter((r) =>
      r.enablingLawName.includes("Health"),
    ),
