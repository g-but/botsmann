          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-xl mb-8 text-amber-100">
                End the era of unaccountable legislation. Every law now has
                clear problem statements, measurable KPIs, and defined
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Pedestrian injuries at intersections have increased 14% in
                      the last two years.
                    </p>
                  </div>
                  <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-amber-50 p-6 rounded-lg border border-amber-100">
              ...
              <p className="text-gray-600">
                Studies show that laws with clearly defined metrics are 3.7x
                more likely to achieve their intended outcomes. Open Law ensures
                every piece of legislation has measurable targets and
                accountability.
              </p>
            </div>
            ...
            <div className="bg-amber-50 p-6 rounded-lg border border-amber-100">
              ...
              <p className="text-gray-600">
                When politicians sponsor laws, they become directly accountable
                for results. Open Law creates a permanent record of promises
                made versus results delivered.
              </p>
            </div>
            ...
            <div className="bg-amber-50 p-6 rounded-lg border border-amber-100">
              ...
              <p className="text-gray-600">
                Open Law transforms citizens from passive subjects into active
                participants. Comment directly on laws, suggest improvements,
                and help measure outcomes in your community.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6">
          <div className="mb-12 text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              A revolutionary framework for legislation that brings clarity,
              measurability, and accountability to every law.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              ...
              <p className="text-gray-600">
                Every law starts with a clearly articulated problem statement
                backed by data. No more vague objectives or hidden agendas.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              ...
              <p className="text-gray-600">
                Each law includes specific, measurable Key Performance
                Indicators that define success. You'll know exactly if a law is
                working.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              ...
              <p className="text-gray-600">
                Clear timeframes for implementation and evaluation prevent laws
                from lingering in limbo. Automatic evaluation at predetermined
                milestones.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              ...
              <p className="text-gray-600">
                Specific individuals and departments are assigned
                responsibility. If a law fails, citizens know exactly who to
                hold accountable.
              </p>
            </div>
          </div>
      ...
      <div id="demo" className="py-16 bg-white">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6">
          <div className="mb-12 text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              In a full implementation, this section would contain real-time
              data on all active laws, their KPIs, and current progress.
            </p>
          </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
              ...
              <div className="px-6 py-4 space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Rising obesity rates across all demographics and limited
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
              ...
              <div className="px-6 py-4 space-y-4">
                <div>
                  <h4 className="text-sm font-medium text-gray-700">PROBLEM</h4>
                  <p className="text-sm text-gray-600">
                    High carbon emissions from municipal operations and aging
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="bg-white text-gray-900 rounded-lg p-8 shadow-lg">
              ...
              <blockquote className="text-xl italic font-medium text-gray-900 mb-4">
                "Cities that have implemented the Open Law framework have seen a
                43% increase in successful policy outcomes. Laws that don't work
                get fixed or removed. Accountability is no longer optional."
              </blockquote>
              <p className="text-sm text-gray-500">
      ...
      <div className="py-16 bg-white">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-xl mb-8 text-gray-600 max-w-3xl mx-auto">
            Join the growing movement of accountable, measurable, and
            transparent legislation. The future of law-making is here.
          </p>
