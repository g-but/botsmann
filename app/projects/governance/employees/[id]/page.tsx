      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <ul className="text-sm text-gray-600 space-y-2">
                <li className="flex">
                  ...
                  {formatCurrency(
                    employee.position.includes("Director") ? 50000 : 10000,
                  )}
                </li>
                <li className="flex">
                  <svg
                ...
                <li className="flex">
                  ...
                  {employee.position.includes("Director") ||
                  employee.position.includes("Chief")
                    ? "Participates in"
                    : "Provides input for"}{" "}
                  strategic planning
                </li>
        ...
        <div className="bg-white shadow rounded-lg overflow-hidden mb-8">
          <div className="px-4 py-5 sm:px-6 bg-gray-50 border-b border-gray-200">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Performance metrics and transparency indicators for this public
              servant.
            </p>
          </div>
          <div className="p-6">
                ...
                <div className="bg-green-50 rounded-lg p-4">
                  ...
                  <div className="w-full bg-white rounded-full h-2">
                    <div
                      ...
                      style={{
                        width: `${Math.round(employee.transparency * 0.95)}%`,
                      }}
                    ></div>
                  </div>
                ...
                <div className="bg-blue-50 rounded-lg p-4">
                  ...
                  <div className="w-full bg-white rounded-full h-2">
                    <div
                      ...
                      style={{
                        width: `${Math.round(employee.transparency * 0.9)}%`,
                      }}
                    ></div>
                  </div>
        ...
        <div className="bg-white shadow rounded-lg overflow-hidden">
          <div className="px-4 py-5 sm:px-6 bg-gray-50 border-b border-gray-200">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Ways to contact this employee or provide feedback on their
              performance.
            </p>
          </div>
          <div className="px-4 py-5 sm:p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Your feedback helps improve public service and ensures
                  accountability.
                </p>
                <button
                  type="button"
