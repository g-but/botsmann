      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        ...
        <div className="bg-white shadow rounded-lg p-6 mb-8">
          ...
          <p className="text-gray-600 mb-6">
            Our employee transparency system promotes accountability by making
            key information about public servants available to citizens. Review
            roles, responsibilities, and performance metrics for the individuals
              ...
              >
                <div className="bg-blue-50 p-4 border-b border-gray-200">
                  <div className="flex items-start justify-between">
                    ...
                    <span
                      className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getTransparencyColor(employee.transparency)} bg-opacity-10`}
                    >
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <p className="text-gray-600 mb-4">
            Our employee profiles adhere to strict standards of transparency
            while respecting privacy. Here's what's included:
          </p>
