                ...
                >
                  <div className="flex justify-between items-start">
                    ...
                    <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                      agency.transparencyScore >= 90 ? 'bg-green-100 text-green-800' :
                      agency.transparencyScore >= 70 ? 'bg-blue-100 text-blue-800' :
                      agency.transparencyScore >= 50 ? 'bg-yellow-100 text-yellow-800' :
                  ...
                  {sampleAgencies
                    ...
                    <tr key={agency.id}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className={`text-xs font-medium px-2.5 py-0.5 rounded-full inline-flex ${
                          agency.transparencyScore >= 90 ? 'bg-green-100 text-green-800' :
                          agency.transparencyScore >= 70 ? 'bg-blue-100 text-blue-800' :
                          agency.transparencyScore >= 50 ? 'bg-yellow-100 text-yellow-800' :
                          'bg-red-100 text-red-800'
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className={`inline-flex items-center text-sm ${
                          agency.citizenImpact.satisfactionScore >= 90 ? 'text-green-600' :
                          agency.citizenImpact.satisfactionScore >= 70 ? 'text-blue-600' :
                          agency.citizenImpact.satisfactionScore >= 50 ? 'text-yellow-600' :
                          'text-red-600'
                        }`}>
