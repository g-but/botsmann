    ...
    <div className="min-h-screen bg-gray-50 pt-20 pb-12">
        ...
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 py-12 md:py-20">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-xl mb-8 text-blue-100">End financial opacity in government forever. A revolutionary transaction system that gives every taxpayer direct visibility into how their money is spent.</p>
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href={{ pathname: "#demo" }} className="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md bg-white text-blue-700 hover:bg-blue-50">
            ...
            <div className="hidden md:block">
              <div className="relative p-6 bg-white rounded-lg shadow-xl">
                <div className="absolute -top-4 -right-4 bg-green-100 px-4 py-1 rounded-full text-green-800 text-sm font-medium">LIVE</div>
                <div className="flex justify-between items-center mb-4">
                  <div>
                    <h3 className="text-lg font-medium text-gray-900">Department of Transportation</h3>
      ...
      <div id="benefits" className="py-16 bg-white">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-900">Why Open Pay is Indispensable</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-blue-50 p-6 rounded-lg border border-blue-100">
              <div className="text-blue-600 text-4xl mb-4">⚡</div>
              <h3 className="text-xl font-semibold mb-3 text-gray-900">Eliminate Wasteful Spending</h3>
              <p className="text-gray-600">Research shows public scrutiny reduces unnecessary government spending by up to 18% while improving service quality. Open Pay provides the transparency needed to identify and eliminate waste.</p>
            </div>
            
            <div className="bg-blue-50 p-6 rounded-lg border border-blue-100">
              <div className="text-blue-600 text-4xl mb-4">🛡️</div>
              <h3 className="text-xl font-semibold mb-3 text-gray-900">Prevent Corruption Automatically</h3>
              <p className="text-gray-600">When every dollar is tracked publicly, corruption becomes nearly impossible. Open Pay's transaction verification system creates an environment where financial misconduct is immediately visible.</p>
            </div>
            
            <div className="bg-blue-50 p-6 rounded-lg border border-blue-100">
              <div className="text-blue-600 text-4xl mb-4">📈</div>
              <h3 className="text-xl font-semibold mb-3 text-gray-900">Restore Public Trust</h3>
              <p className="text-gray-600">In regions using similar systems, public trust in government increased by 41%. Open Pay bridges the gap between taxpayers and their government, creating unprecedented accountability.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="py-16 bg-white">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6">
          <div className="mb-12 text-center">
            <h2 className="text-3xl font-bold mb-4 text-gray-900">Implementation Without Disruption</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
      ...
      <div className="bg-blue-600 text-white py-16">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="inline-flex rounded-md shadow">
            <Link href={{ pathname: "/projects/governance", hash: "request-demo" }} className="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-blue-600 bg-white hover:bg-blue-50">
