        ...
        <div className="mb-16">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-sm text-gray-500">
              Investment fund launching 2025
            </span>
          </div>
          ...
          <p className="mb-8 text-lg text-gray-600">
            Accelerating humanity toward technological singularity through
            strategic investments in commodities, research, and subterranean
            development.
          </p>
        </div>
        ...
        <div className="grid gap-8 md:grid-cols-2">
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-600">
                  Strategic commodities: uranium, rare earths, copper, and other
                  critical resources
                </span>
              </li>
              <li className="flex items-start">
                ...
                <span className="text-gray-600">
                  Advanced research funding for AI, fusion energy, and longevity
                  science
                </span>
              </li>
              <li className="flex items-start">
                ...
                <span className="text-gray-600">
                  Subterranean and space-based real estate development via
                  SubSpace Capital
                </span>
              </li>
              <li className="flex items-start">
                ...
                <span className="text-gray-600">
                  Long-term investment horizon (20+ years) focused on
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
            ...
            <p className="mb-6 text-gray-600">
              Botsmann Techno-Capital is dedicated to accelerating humanity's
              progress toward technological singularity—when artificial
              intelligence surpasses human capabilities and leads to
              unprecedented growth and advancement.
            </p>
            <p className="mb-6 text-gray-600">
              Unlike traditional investment funds that focus on quarterly
              returns or existing companies, BTC strategically invests in the
              foundational resources, physical infrastructure, and breakthrough
              research needed to support this technological transformation.
            </p>
            <p className="text-gray-600">
              By focusing on commodities and physical infrastructure rather than
              companies, we ensure direct control of the critical resources
        ...
        <section className="mt-16 mb-16">
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-8 shadow-sm">
            ...
            <p className="text-gray-600 mb-6">
              SubSpace Capital is our specialized real estate division that
              invests in the most undervalued property class: subterranean real
              estate and extraterrestrial development. We focus on:
            </p>
            ...
            <div className="bg-gray-50 p-4 rounded-md">
              <p className="text-sm text-gray-600 italic text-center">
                "The future of humanity may lie beneath the surface—of Earth and
                beyond. By developing subterranean and space-based habitats,
                we're creating the resilient infrastructure needed for the
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-8 shadow-sm">
            <ol className="space-y-4">
              <li className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    We identify and acquire commodities and physical assets that
                    will become increasingly critical for technological
                    advancement.
                  </p>
                </div>
              </li>
              <li className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    We fund breakthrough research that enhances the value of our
                    physical assets and accelerates singularity development.
                  </p>
                </div>
              </li>
              <li className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    We develop the physical and digital infrastructure needed to
                    support exponential technological growth.
                  </p>
                </div>
              </li>
            </ol>
            ...
            <div className="mt-8 p-6 bg-gray-50 rounded-md">
              ...
              <p className="text-gray-600 mb-3">
                For commodity investments, we maintain a balanced portfolio
                approach:
              </p>
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-start">
                ...
                <li className="flex items-start">
                  ...
                  <span>
                    Short positions (5–50%) to capitalize on market
                    inefficiencies
                  </span>
                </li>
              </ul>
        ...
        <section id="waitlist" className="mb-16">
          <div className="rounded-xl bg-gray-50 p-8 text-center">
            ...
            <p className="mb-8 text-lg text-gray-600 max-w-2xl mx-auto">
              Botsmann Techno-Capital is preparing to launch. Join our waitlist
              to be among the first to invest in humanity's technological
              future.
            </p>
            ...
            {formSubmitted ? (
              <div className="max-w-md mx-auto bg-green-50 border border-green-200 rounded-md p-4 text-center">
                ...
                <p className="text-gray-600">
                  ...
                  Botsmann Techno-Capital launches.
                </p>
              </div>
            ) : (
