      ...
      <main className="max-w-screen-xl mx-auto px-6 py-12">
        ...
        <section className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Unlock the power of AI and robotics to streamline operations, boost
            efficiency, and drive innovation. Our intelligent solutions adapt to
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow">
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Master Swiss German with our AI-powered teacher that provides
                  contextual learning and cultural insights for Switzerland.
                </p>
                <Link
                  href="/bots/swiss-german-teacher"
                  className="text-openai-green hover:text-opacity-80 font-medium"
                >
                  Learn more →
                </Link>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow relative">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Enhance your research workflow with AI automation that
                  organizes materials, provides updates, and sparks innovation.
                </p>
                <Link
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow relative">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Get instant legal insights and document analysis powered by
        ...
        <section className="bg-gradient-to-r from-gray-50 to-blue-50 rounded-xl p-8 md:p-12 text-center">
          ...
          <p className="text-lg text-gray-700 mb-6 max-w-2xl mx-auto">
            We're bringing together engineers and researchers to build the next
            generation of AI tools. Share your expertise and help shape the
          ...
          <div className="flex flex-col md:flex-row gap-6 max-w-3xl mx-auto mb-8 text-left">
            <div className="bg-white p-6 rounded-lg shadow-sm flex-1">
              ...
              <p className="text-gray-700">
                Contribute to cutting-edge AI projects, work with the latest
                technologies, and help build scalable solutions that solve
                real-world problems.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm flex-1">
              ...
              <p className="text-gray-700">
                Apply your domain expertise, develop novel algorithms, and
                collaborate on publications while making direct impact on
