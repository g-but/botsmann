...
const restoreEnv = {
  ...
  RICARDO_API_KEY: process.env.RICARDO_API_KEY,
};

afterEach(() => {
  process.env.AMAZON_API_KEY = restoreEnv.AMAZON_API_KEY;
  process.env.AMAZON_SECRET_KEY = restoreEnv.AMAZON_SECRET_KEY;
  process.env.RICARDO_API_KEY = restoreEnv.RICARDO_API_KEY;
});
